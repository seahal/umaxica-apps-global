...
> `www.*`); regional surfaces (docs, news, help) live in a separate repository. The classification
> results below assume the abandoned engine/wrapper layout and no longer reflect the target file
> placement. See `adr/split-into-regional-and-global-repos.md` for the current direction.

**Original status:** Completed (2026-04-18)
