...
> `www.*`); regional surfaces (docs, news, help) live in a separate repository. Do not follow this
> plan. See `adr/split-into-regional-and-global-repos.md` for the current direction.

**Original status:** Active (2026-04-18)
