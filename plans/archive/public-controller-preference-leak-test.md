...
`test/controllers/apex/public_controller_test.rb`, and
...
covers part of this, but the `Apex` and `Sign` equivalents must stay aligned as those bases migrate
...
For each lightweight open base (`Apex::OpenController`, `Sign::OpenController`, and existing
