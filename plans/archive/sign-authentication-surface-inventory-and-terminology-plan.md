...
Archived during active-plan strictness cleanup on 2026-06-14. This file records historical
sign-in/sign-up inventory and terminology alignment for `app`, `com`, and `org`; it is not an active
implementation plan and does not authorize large authentication implementation changes.

Current implementation work should use `plans/active/acme-sign-core-base-port-implementation.md`,
`plans/active/sign-acme-boundary-remediation.md`, and active state-machine plans instead.
