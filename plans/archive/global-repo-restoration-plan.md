...
Archived (2026-05-07). Split into per-item backlog files.

> **Archive notice (2026-05-07):** This master list has been broken out into 30 individual backlog
> files under `plans/backlog/restoration-*.md`, one per work item. Use those files for tracking.
> This document is preserved as the original snapshot for context but is no longer the source of
> truth.
>
> The split files follow the naming convention `restoration-<id>-<slug>.md` where `<id>` matches the
> section/item identifier in the index below (e.g., `restoration-a1-email-otp-races.md`,
> `restoration-d1-pundit-to-action-policy.md`).
>
> ### Per-item index
>
> **A. Security / Authentication**
>
> - A1 → `plans/backlog/restoration-a1-email-otp-races.md`
> - A2 → `plans/backlog/restoration-a2-refresh-revoke-aal-hardening.md`
> - A3 → `plans/backlog/restoration-a3-oidc-authn-hardening.md`
> - A4 → `plans/backlog/restoration-a4-oidc-claims-model.md`
> - A5 → `plans/backlog/restoration-a5-oauth-2-1-compliance.md`
...
>
> - B1 → `plans/backlog/restoration-b1-account-workspace-avatar-billing.md`
> - B2 → `plans/backlog/restoration-b2-setting-preference-polymorphic-removal.md`
> - B3 → `plans/backlog/restoration-b3-database-consistency-repair.md`
> - B4 → `plans/backlog/restoration-b4-treeable-cte-refactor.md`
> - B5 → `plans/backlog/restoration-b5-chronicle-audit-db-consolidation.md`
>
> **C. Cache / Queue infrastructure**
>
> - C1 → `plans/backlog/restoration-c1-solid-cache-and-queue.md`
>
> **D. Authorization**
>
> - D1 → `plans/backlog/restoration-d1-pundit-to-action-policy.md`
>
> **E. Contact / Auth integration**
>
> - E1 → `plans/backlog/restoration-e1-contact-actor-context.md`
> - E2 → `plans/backlog/restoration-e2-contact-customer-canonicalization.md`
>
> **F. Preference / i18n / Frontend**
>
> - F1 → `plans/backlog/restoration-f1-localization-preference-flow.md`
> - F2 → `plans/backlog/restoration-f2-theme-preference-cookie.md`
> - F3 → `plans/backlog/restoration-f3-i18n-inline-default-ban.md`
> - F4 → `plans/backlog/restoration-f4-frontend-toolchain-vite-plus.md`
>
> **G. Test quality**
>
> - G1 → `plans/backlog/restoration-g1-remove-any-instance-stub.md`
> - G2 → `plans/backlog/restoration-g2-oidc-callback-integration-tests.md`
>
> **H. Audit findings (audit-findings-2026-03-30)**
>
> - H1 → `plans/backlog/restoration-h1-trusted-origins-localhost.md`
> - H2 → `plans/backlog/restoration-h2-contact-idor-fix.md`
> - H3 → `plans/backlog/restoration-h3-god-class-decomposition.md`
> - H4 → `plans/backlog/restoration-h4-n-plus-one-fixes.md`
> - H5 → `plans/backlog/restoration-h5-japanese-hardcoded-string-sweep.md`

**Original status:** Active (2026-04-26). Working list of items to re-apply after the repository was
reverted from a degraded state. To be implemented incrementally by another agent.
