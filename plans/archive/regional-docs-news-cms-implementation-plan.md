...
> abandoned. The docs / news / help surfaces have been moved to a separate **regional** repository
> and are no longer this repository's concern. The Foundation-owned CMS / Distributor-owned delivery
> split described below no longer applies in this repo. Do not follow this plan. See
> `adr/split-into-regional-and-global-repos.md` for the current direction.

**Original status:** Active draft (2026-04-17)
