...
> repository (docs / news / help). The wrapper-app architecture (`apps/identity`, `apps/zenith`,
> `apps/foundation`, `apps/distributor`) described below is permanently retired. Treat this document
> as historical only.
