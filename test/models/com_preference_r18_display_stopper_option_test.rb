...
# == Schema Information
#
# Table name: com_preference_r18_display_stopper_options
...
class ComPreferenceR18DisplayStopperOptionTest < ActiveSupport::TestCase
  test "name returns nothing for NOTHING id" do
    option = ComPreferenceR18DisplayStopperOption.new(id: ComPreferenceR18DisplayStopperOption::NOTHING)

    assert_equal "nothing", option.name
  end

  test "name returns approved for APPROVED id" do
    option = ComPreferenceR18DisplayStopperOption.new(id: ComPreferenceR18DisplayStopperOption::APPROVED)

    assert_equal "approved", option.name
  end

  test "name returns deny for DENY id" do
    option = ComPreferenceR18DisplayStopperOption.new(id: ComPreferenceR18DisplayStopperOption::DENY)

    assert_equal "deny", option.name
  end

  test "name returns nil for unknown id" do
    option = ComPreferenceR18DisplayStopperOption.new(id: 999)
