...
class OperatorClientOccurrenceTest < ActiveSupport::TestCase
  test "associations" do
    staff = OperatorOccurrence.create!(body: "staff-001")
    user = ClientOccurrence.create!(body: "user-001")
    record = OperatorClientOccurrence.new(
  ...
  test "uniqueness validation" do
    ...
    OperatorClientOccurrence.create!(staff_occurrence: staff, user_occurrence: user)
    duplicate = OperatorClientOccurrence.new(staff_occurrence: staff, user_occurrence: user)
