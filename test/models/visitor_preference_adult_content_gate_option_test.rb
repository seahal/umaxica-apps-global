...
# == Schema Information
#
# Table name: visitor_preference_adult_content_gate_options
...
class VisitorPreferenceAdultContentGateOptionTest < ActiveSupport::TestCase
  test "name returns nothing for NOTHING id" do
    option = VisitorPreferenceAdultContentGateOption.new(id: VisitorPreferenceAdultContentGateOption::NOTHING)
  ...
  test "name returns deny for DENY id" do
    option = VisitorPreferenceAdultContentGateOption.new(id: VisitorPreferenceAdultContentGateOption::DENY)

    assert_equal "deny", option.name
  end

  test "name returns nil for unknown id" do
    option = VisitorPreferenceAdultContentGateOption.new(id: 999)
