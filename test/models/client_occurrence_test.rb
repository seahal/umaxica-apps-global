...
class ClientOccurrenceTest < ActiveSupport::TestCase
  test "defaults status_id to nothing" do
    record = build_occurrence(ClientOccurrence, body: "user-occur-2", public_id: "X" * 21)

    assert_equal ClientOccurrenceStatus::NOTHING, record.status_id
  end

  test "lifecycle timestamps default" do
    record = build_occurrence(ClientOccurrence, body: "user-occur-1", public_id: "Y" * 21)
