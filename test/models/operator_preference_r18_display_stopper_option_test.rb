...
# == Schema Information
#
# Table name: operator_preference_r18_display_stopper_options
...
class OperatorPreferenceR18DisplayStopperOptionTest < ActiveSupport::TestCase
  test "name returns nothing for NOTHING id" do
    option = OperatorPreferenceR18DisplayStopperOption.new(id: OperatorPreferenceR18DisplayStopperOption::NOTHING)

    assert_equal "nothing", option.name
  end

  test "name returns approved for APPROVED id" do
    option = OperatorPreferenceR18DisplayStopperOption.new(id: OperatorPreferenceR18DisplayStopperOption::APPROVED)

    assert_equal "approved", option.name
  end

  test "name returns deny for DENY id" do
    option = OperatorPreferenceR18DisplayStopperOption.new(id: OperatorPreferenceR18DisplayStopperOption::DENY)

    assert_equal "deny", option.name
  end

  test "name returns nil for unknown id" do
    option = OperatorPreferenceR18DisplayStopperOption.new(id: 999)
