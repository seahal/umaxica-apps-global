...
class OrgPreferenceR18DisplayStopperOptionTest < ActiveSupport::TestCase
  test "name returns nothing for NOTHING id" do
    option = OrgPreferenceR18DisplayStopperOption.new(id: OrgPreferenceR18DisplayStopperOption::NOTHING)

    assert_equal "nothing", option.name
  end

  test "name returns approved for APPROVED id" do
    option = OrgPreferenceR18DisplayStopperOption.new(id: OrgPreferenceR18DisplayStopperOption::APPROVED)

    assert_equal "approved", option.name
  end

  test "name returns deny for DENY id" do
    option = OrgPreferenceR18DisplayStopperOption.new(id: OrgPreferenceR18DisplayStopperOption::DENY)

    assert_equal "deny", option.name
  end

  test "name returns nil for unknown id" do
    option = OrgPreferenceR18DisplayStopperOption.new(id: 999)
