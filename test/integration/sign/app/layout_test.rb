...
class Sign::App::LayoutTest < ActionDispatch::IntegrationTest
  ...
  test "layout links when not logged in" do
    ...
    assert_select "nav" do
      assert_select "a[href*=?]", sign_app_sign_up_entrance_path, text: I18n.t("sign.app.layout.nav.sign_up")
      assert_select "a[href*=?]", sign_app_sign_in_entrance_path, text: I18n.t("sign.app.layout.nav.log_in")
  ...
  #   assert_select "nav" do
  #     assert_select "a[href=?]", sign_app_sign_up_entrance_path
  #     assert_select "a[href=?]", sign_app_sign_in_entrance_path
  #     assert_select "a[href*=?]", "/configuration", count: 0
  #     assert_select "a[href*=?][data-turbo-method='delete']", "/authentication", count: 0
  #   end
  # end
