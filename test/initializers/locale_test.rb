...
class LocaleInitializerTest < ActiveSupport::TestCase
  ...
  test "provides english labels for app region preference links" do
    ...
    I18n.with_locale(:en) do
      ...
      assert_equal "JP", I18n.t("acme.app.preferences.regions.select_region_selector.JP")
      assert_equal "US", I18n.t("acme.app.preferences.regions.select_region_selector.US")
  ...
  test "provides localized labels for com region preference links" do
    ...
    I18n.with_locale(:ja) do
      ...
      assert_equal "JP", I18n.t("acme.com.preferences.regions.select_region_selector.JP")
      assert_equal "US", I18n.t("acme.com.preferences.regions.select_region_selector.US")
