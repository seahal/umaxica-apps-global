...
class BaseHealthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "network host health probes return OK without redirect" do
    ...
    get base_network_health_livenesses_url, headers: browser_headers

    assert_probe_response("liveness")

    get base_network_health_readinesses_url, headers: browser_headers

    assert_probe_response("readiness")

    get base_network_health_startups_url, headers: browser_headers
  ...
  test "developer host health probes return OK without redirect" do
    ...
    get base_developer_health_livenesses_url, headers: browser_headers

    assert_probe_response("liveness")

    get base_developer_health_readinesses_url, headers: browser_headers

    assert_probe_response("readiness")

    get base_developer_health_startups_url, headers: browser_headers
