...
class Base::Org::Oidc::LogoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    set_access_cookie(base_access_token(@operator, resource_type: "operator", jwt_issuer_id: "surface:BASE_ORG"))
  ...
  test "POST with a cross-origin challenge hands off to the sign surface for this realm" do
    transaction =
      AcmeLogoutTransactionCoordinator.issue!(
        ...
        completion_url: AcmeLogoutTransactionCoordinator.completion_url_for(origin_surface: "side", ri: "jp", surface: "org"),
        surface: "org",
        ri: "jp",
      ).transaction
