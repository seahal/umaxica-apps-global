    ...
    module Preference
      class EmailsControllerTest < ActionDispatch::IntegrationTest
        ...
        test "controller uses bare unsubscribe boundary" do
          assert_operator ::Base::Org::Preference::EmailsController, :<, ::Base::Org::BareController
          assert_not_operator ::Base::Org::Preference::EmailsController, :<, ::Base::Org::PreferencesBaseController
        end
        ...
        test "POST create turns operator promotional email off" do
          post base_org_preference_email_path(@email), params: { token: @token }
        ...
        test "DELETE destroy without csrf token is rejected when forgery protection is enabled" do
          with_forgery_protection do
            ...
            delete base_org_preference_email_path(@email),
        ...
        test "unknown public id does not unsubscribe operator email" do
          post base_org_preference_email_path("missing-public-id"), params: { token: @token }
...
class Base::Org::Preference::EmailsControllerTest
