    ...
    module Preference
      class EmailsControllerTest < ActionDispatch::IntegrationTest
        ...
        test "controller uses bare unsubscribe boundary" do
          assert_operator ::Base::Com::Preference::EmailsController, :<, ::Base::Com::BareController
          assert_not_operator ::Base::Com::Preference::EmailsController, :<, ::Base::Com::PreferencesBaseController
        end
        ...
        test "POST create turns visitor promotional email off" do
          post base_com_preference_email_path(@email), params: { token: @token }
        ...
        test "missing token does not unsubscribe visitor email" do
          post base_com_preference_email_path(@email)
...
class Base::Com::Preference::EmailsControllerTest
