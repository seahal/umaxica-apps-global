...
class Sign::App::Settings::SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "index returns active sessions as JSON" do
    ...
    get sign_app_settings_sessions_url(ri: "jp", format: :json), headers: headers
  ...
  test "index marks refreshed session as current after transparent refresh" do
    ...
    assert_select "form[action^='#{sign_app_settings_session_path(refreshed_token.public_id)}']", 0
  end
  ...
  test "index requires authentication" do
    get sign_app_settings_sessions_url(ri: "jp"), headers: @unauthenticated_headers
  ...
  test "destroy revokes session and returns see_other" do
    ...
    delete sign_app_settings_session_url(user_token.public_id, ri: "jp"), headers: @headers
  ...
  test "destroy current session returns error redirect instead of revoking" do
    ...
    delete sign_app_settings_session_url(current_session_id, ri: "jp"), headers: @headers

    assert_response :redirect
    assert_match(/settings\/sessions/, response.location)
  ...
  test "destroy non-existent session returns 404" do
    delete sign_app_settings_session_url("nonexistent_public_id", ri: "jp"), headers: @headers
  ...
  test "destroy requires authentication" do
    ...
    delete sign_app_settings_session_url(user_token.public_id, ri: "jp"),
  ...
  test "destroy does not revoke session belonging to another user" do
    ...
    delete sign_app_settings_session_url(other_user_token.public_id, ri: "jp"),
           headers: @headers
  ...
  test "others revokes active sessions except current session" do
    ...
    delete others_sign_app_settings_sessions_url(ri: "jp"), headers: @headers
  ...
  test "others requires authentication" do
    delete others_sign_app_settings_sessions_url(ri: "jp"), headers: @unauthenticated_headers
  ...
  test "index shows revoke all other sessions button" do
    ...
    assert_response :success
    assert_select "form[action^='#{others_sign_app_settings_sessions_path}']"
    assert_select "button", text: I18n.t("sign.app.settings.sessions.revoke.others_button")
  end
  ...
  test "revoke_all revokes all sessions including current and clears cookies" do
    ...
    delete revoke_all_sign_app_settings_sessions_url(ri: "jp"), headers: @headers
  ...
  test "revoke_all requires authentication" do
    delete revoke_all_sign_app_settings_sessions_url(ri: "jp"), headers: @unauthenticated_headers
