...
module Sign::App::Settings
  ...
  class EmergencyKeysControllerTest < ActionDispatch::IntegrationTest
    ...
    test "renders the missing state for a signed-in owner without a reveal token" do
      get sign_app_settings_emergency_key_url(ri: "jp"), headers: @headers
    ...
    test "redirects when not signed in" do
      get sign_app_settings_emergency_key_url(ri: "jp"), headers: { "Host" => @host }
