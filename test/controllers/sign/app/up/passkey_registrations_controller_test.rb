...
module Sign::App::Up
  class PasskeyRegistrationsControllerTest < ActionDispatch::IntegrationTest
    ...
    test "GET show returns 200 with passkey endpoint data attrs" do
      ...
      get sign_app_up_telephone_passkey_registration_url(ri: "jp")

      assert_response :success
      assert_select "[data-controller='passkey-registration']"
      begin_path = begin_sign_app_up_telephone_passkey_registration_path(ri: "jp")

      assert_select "[data-passkey-registration-begin-url-value='#{begin_path}']"
      finish_path = sign_app_up_telephone_passkey_registration_path(ri: "jp")
    ...
    test "POST begin returns challenge and options" do
      ...
      post begin_sign_app_up_telephone_passkey_registration_url(ri: "jp")
    ...
    test "POST begin returns json error when registration session is missing" do
      post begin_sign_app_up_telephone_passkey_registration_url, as: :json
    ...
    test "POST create saves passkey and returns checkpoint redirect on success" do
      ...
      WebAuthn::Credential.stub(:from_create, mock_credential) do
        assert_difference("ClientPasskey.count", 1) do
          post sign_app_up_telephone_passkey_registration_url(ri: "jp"), params: {
