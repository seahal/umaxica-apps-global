      ...
      module Region
        class LanguagesControllerTest < ActionDispatch::IntegrationTest
          ...
          test "edit renders only japanese and english language options" do
            get edit_sign_app_preference_language_url(ri: "jp")
          ...
          test "edit uses ri and lx params for japanese and english labels" do
            {
              ...
              %w(jp us).each do |ri|
                get edit_sign_app_preference_language_url(ri: ri, lx: lx)
          ...
          test "edit redirects invalid ri to fallback region" do
            get edit_sign_app_preference_language_url(lx: "en", ri: "kr")

            assert_redirected_to edit_sign_app_preference_language_url(lx: "en", ri: "jp")
          end

          test "edit redirects blank ri to fallback region" do
            get edit_sign_app_preference_language_url(lx: "en", ri: "")
