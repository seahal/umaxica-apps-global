...
class Sign::App::Configuration::ConnectionsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "index displays connected RP details" do
    get sign_app_configuration_connections_url(ri: "jp"), headers: @headers
  ...
  test "show displays connection details" do
    get sign_app_configuration_connection_url(@connection.public_id, ri: "jp"), headers: @headers
  ...
  test "index requires authentication" do
    get sign_app_configuration_connections_url(ri: "jp"), headers: host_headers(@host)
  ...
  test "connection from another user is not visible" do
    ...
    get sign_app_configuration_connection_url(other.public_id, ri: "jp"), headers: @headers

    assert_response :not_found
  end

  test "destroy revokes connection and linked RP tokens" do
    delete sign_app_configuration_connection_url(@connection.public_id, ri: "jp"), headers: @headers

    assert_response :see_other
    assert_redirected_to sign_app_configuration_connections_url(ri: "jp")
