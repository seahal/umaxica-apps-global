...
class Sign::App::Configuration::SecretCredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    with_prosopite_paused do
      get sign_app_configuration_secret_credentials_url(ri: "jp"), headers: authenticated_headers
    end
  ...
  test "index requires step-up when session freshness is stale" do
    ...
    assert_equal "configuration_secret_credential", query["scope"]
  ...
  test "index renders destroy as delete form" do
    ...
    assert_select "form[action=?][method=?]",
                  sign_app_configuration_secret_credential_path(@user_secret_credential, ri: "jp"),
                  "post" do
  ...
  test "should get show" do
    with_prosopite_paused do
      get sign_app_configuration_secret_credential_url(@user_secret_credential, ri: "jp"),
  ...
  test "new redirects to setup when MFA is unavailable" do
    ...
    with_prosopite_paused do
      get new_sign_app_configuration_secret_credential_url(ri: "jp"), headers: headers
    end
  ...
  test "new returns forbidden plain message when user has no verified recovery identity" do
    ...
    token = ClientToken.create!(
      ...
      last_step_up_scope: "configuration_secret_credential",
    )
    headers = browser_headers.merge(
      "X-TEST-CURRENT-USER" => user.id.to_s,
      "X-TEST-SESSION-PUBLIC-ID" => token.public_id,
  ...
  test "should show back link on new page" do
    ...
    with_prosopite_paused do
      get new_sign_app_configuration_secret_credential_url(ri: "jp"), headers: authenticated_headers
    end
  ...
  test "should get edit" do
    with_prosopite_paused do
      get edit_sign_app_configuration_secret_credential_url(@user_secret_credential, ri: "jp"),
          headers: authenticated_headers
    end
  ...
  test "should create secret_credential and redirect to index" do
    ...
    assert_difference("ClientSecretCredential.count", 1) do
      assert_difference(
        ...
        with_prosopite_paused do
          post sign_app_configuration_secret_credentials_url(ri: "jp"),
    ...
    assert_equal "configuration_secret_credential", @token.last_step_up_scope
  end
  ...
  test "should update secret_credential name and status" do
    assert_difference(
      ...
      with_prosopite_paused do
        patch sign_app_configuration_secret_credential_url(@user_secret_credential, ri: "jp"),
  ...
  test "should get destroy" do
    ...
    AuthMethodGuard.stub(:last_method?, false) do
      with_prosopite_paused do
        delete sign_app_configuration_secret_credential_url(@user_secret_credential, ri: "jp"),
               headers: authenticated_headers
      end
    end
  ...
  test "should access secret_credential by public_id" do
    with_prosopite_paused do
      get sign_app_configuration_secret_credential_url(@user_secret_credential.public_id, ri: "jp"),
          headers: authenticated_headers
    end
  ...
  test "should not access secret_credential by numeric ID" do
    with_prosopite_paused do
      get sign_app_configuration_secret_credential_url(@user_secret_credential.id, ri: "jp"),
          headers: authenticated_headers
    end
  ...
  test "should return 404 for other user's secret_credential" do
    ...
    with_prosopite_paused do
      get sign_app_configuration_secret_credential_url(other_secret_credential.public_id, ri: "jp"),
          headers: authenticated_headers
    end
  ...
  test "update does not disable last method" do
    ...
    AuthMethodGuard.stub(:last_method?, true) do
      with_prosopite_paused do
        patch sign_app_configuration_secret_credential_url(secret_credential, ri: "jp"),
