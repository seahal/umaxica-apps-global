...
class Sign::Com::Settings::Telephones::RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  def with_current_registration_telephone(telephone)
    original_method =
      Sign::Com::Settings::Telephones::RegistrationsController.instance_method(:current_registration_telephone)
