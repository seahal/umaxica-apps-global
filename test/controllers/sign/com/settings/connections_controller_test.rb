...
class Sign::Com::Settings::ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "index displays connected RP details" do
    get sign_com_settings_connections_url(ri: "jp"), headers: @headers
  ...
  test "show displays connection details" do
    get sign_com_settings_connection_url(@connection.public_id, ri: "jp"), headers: @headers
  ...
  test "index requires authentication" do
    get sign_com_settings_connections_url(ri: "jp"), headers: host_headers(@host)
  ...
  test "connection from another visitor is not visible" do
    ...
    get sign_com_settings_connection_url(other.public_id, ri: "jp"), headers: @headers

    assert_response :not_found
  end

  test "destroy revokes connection and linked RP tokens" do
    delete sign_com_settings_connection_url(@connection.public_id, ri: "jp"), headers: @headers

    assert_response :see_other
    assert_redirected_to sign_com_settings_connections_url(ri: "jp")
