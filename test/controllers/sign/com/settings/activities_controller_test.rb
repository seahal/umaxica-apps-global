...
class Sign::Com::Settings::ActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "requires login and preserves ri parameter" do
    get sign_com_settings_activities_url(ri: "jp"), headers: { "Host" => @host }
  ...
  test "shows only current visitor activity logs" do
    ...
    get sign_com_settings_activities_url(ri: "jp"), headers: request_headers
  ...
  test "helper methods cover labels ip addresses context and fallbacks" do
    controller = Sign::Com::Settings::ActivitiesController.new
    ...
    assert_equal I18n.t("sign.app.settings.activity.events.logged_in"),
