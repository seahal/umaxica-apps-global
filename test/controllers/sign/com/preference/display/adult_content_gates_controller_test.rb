      ...
      module Display
        class AdultContentGatesControllerTest < ActionDispatch::IntegrationTest
          ...
          test "preferences index links to r18 display stopper settings" do
            ...
            assert_select "a[href*=?]", edit_sign_com_preference_display_adult_content_gate_path
          end

          test "edit renders unset approved and deny choices" do
            get edit_sign_com_preference_display_adult_content_gate_url(ri: "jp", lx: "en"),
                headers: as_visitor_headers(@visitor, host: @host)
          ...
          test "PATCH update stores approved preference" do
            patch sign_com_preference_display_adult_content_gate_url(ri: "jp", lx: "en"),
