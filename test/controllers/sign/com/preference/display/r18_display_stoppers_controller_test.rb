      ...
      module Display
        class R18DisplayStoppersControllerTest < ActionDispatch::IntegrationTest
          ...
          test "preferences index links to r18 display stopper settings" do
            ...
            assert_select "a[href*=?]", edit_sign_com_preference_display_r18_display_stopper_path
          end

          test "edit renders unset approved and deny choices" do
            get edit_sign_com_preference_display_r18_display_stopper_url(ri: "jp", lx: "en"),
                headers: as_visitor_headers(@visitor, host: @host)
          ...
          test "PATCH update stores approved preference" do
            patch sign_com_preference_display_r18_display_stopper_url(ri: "jp", lx: "en"),
            ...
            assert_equal VisitorPreferenceR18DisplayStopperOption::APPROVED,
                         preference.visitor_preference_r18_display_stopper.option_id
          end
        end
      end
    end
