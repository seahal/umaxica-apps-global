...
class Sign::Com::Configuration::Emails::RegistrationsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "create sends OTP email and stores notification preference" do
    assert_enqueued_emails 1 do
      post sign_com_configuration_emails_registration_url(ri: "jp"),
           params: {
    ...
    assert_response :redirect
    assert_redirected_to edit_sign_com_configuration_emails_registration_url(ri: "jp")
