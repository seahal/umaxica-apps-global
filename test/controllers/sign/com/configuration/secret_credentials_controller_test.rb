...
class Sign::Com::Configuration::SecretCredentialsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "index show new edit and access by public id" do
    get sign_com_configuration_secret_credentials_url(ri: "jp"), headers: request_headers

    assert_response :success

    get sign_com_configuration_secret_credential_url(@secret_credential.public_id, ri: "jp"), headers: request_headers

    assert_response :success

    get new_sign_com_configuration_secret_credential_url(ri: "jp"), headers: request_headers

    assert_response :success

    get edit_sign_com_configuration_secret_credential_url(@secret_credential.public_id, ri: "jp"),
  ...
  test "ensure_verified_recovery_identity_for_registration! renders forbidden " \
    ...
    controller = Sign::Com::Configuration::SecretCredentialsController.new
  ...
  test "create persists secret_credential and redirects" do
    ...
    assert_difference("VisitorSecretCredential.count", 1) do
      post sign_com_configuration_secret_credentials_url(ri: "jp"),
  ...
  test "update changes secret_credential name and status" do
    AuthMethodGuard.stub(:last_method?, false) do
      patch sign_com_configuration_secret_credential_url(@secret_credential.public_id, ri: "jp"),
  ...
  test "destroy removes secret_credential and regenerate is not implemented" do
    ...
    post regenerate_sign_com_configuration_secret_credential_url(secret_credential.public_id, ri: "jp"), headers: {
      "Host" => @host,
      "X-TEST-CURRENT-RESOURCE" => visitor.id,
      "X-TEST-SESSION-PUBLIC-ID" => token.public_id,
    }
