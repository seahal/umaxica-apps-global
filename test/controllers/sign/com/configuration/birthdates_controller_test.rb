...
module Sign::Com::Configuration
  class BirthdatesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "shows birthdate to signed in visitor" do
      get sign_com_configuration_birthdate_url(ri: "jp"), headers: @headers
    ...
    test "shows unset state" do
      ...
      assert_response :success
      assert_includes response.body, I18n.t("sign.com.configuration.birthdate.show.not_set")
    end
    ...
    test "does not route mutation or edit actions" do
      assert_raises(NoMethodError) do
        edit_sign_com_configuration_birthdate_url(ri: "jp")
      end

      patch sign_com_configuration_birthdate_url(ri: "jp"), headers: @headers, params: {
