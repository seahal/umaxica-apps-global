...
class SignPreferencesBaseControllerTest < ActiveSupport::TestCase
  ...
  test "open preference bases keep their surface layouts" do
    assert_equal "sign/app/application", Sign::App::Preference::Region::TimeFormatsController._layout
    assert_equal "sign/com/application", Sign::Com::Preference::Region::TimeFormatsController._layout
    assert_equal "sign/org/application", Sign::Org::Preference::Region::TimeFormatsController._layout
  end
