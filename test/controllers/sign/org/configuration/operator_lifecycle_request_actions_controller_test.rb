...
class Sign::Org::Configuration::OperatorLifecycleRequestActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "another operator can approve a pending request" do
    ...
    post sign_org_configuration_operator_lifecycle_request_approval_url(request, ri: "jp"),
  ...
  test "another operator can execute an approved request" do
    ...
    post sign_org_configuration_operator_lifecycle_request_execution_url(request, ri: "jp"),
         headers: authenticated_headers
