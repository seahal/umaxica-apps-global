...
module Sign::Org::Configuration
  class BirthdatesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "shows unset state" do
      ...
      assert_response :success
      assert_includes response.body, I18n.t("sign.org.configuration.birthdate.show.not_set")
    end
    ...
    test "does not route mutation or edit actions" do
      assert_raises(NoMethodError) do
        edit_sign_org_configuration_birthdate_url(ri: "jp")
      end

      patch sign_org_configuration_birthdate_url(ri: "jp"), headers: @headers, params: {
