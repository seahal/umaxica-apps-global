...
class Sign::Org::Configuration::SecretCredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    get sign_org_configuration_secret_credentials_url(ri: "jp"), headers: authenticated_headers

    assert_response :success
  end

  test "should get show" do
    get sign_org_configuration_secret_credential_url(@staff_secret_credential, ri: "jp"), headers: authenticated_headers

    assert_response :success
  end

  test "should get new" do
    get new_sign_org_configuration_secret_credential_url(ri: "jp"), headers: authenticated_headers

    assert_response :success
  end

  test "should get edit" do
    get edit_sign_org_configuration_secret_credential_url(@staff_secret_credential, ri: "jp"),
  ...
  test "should create secret_credential and redirect to index" do
    assert_difference("OperatorSecretCredential.count", 1) do
      post sign_org_configuration_secret_credentials_url(ri: "jp"),
  ...
  test "should update secret_credential and redirect to index" do
    patch sign_org_configuration_secret_credential_url(@staff_secret_credential, ri: "jp"),
  ...
  test "should get destroy" do
    delete sign_org_configuration_secret_credential_url(@staff_secret_credential, ri: "jp"),
  ...
  test "should access secret_credential by public_id" do
    get sign_org_configuration_secret_credential_url(@staff_secret_credential.public_id, ri: "jp"),
        headers: authenticated_headers
  ...
  test "should not access secret_credential by numeric ID" do
    get sign_org_configuration_secret_credential_url(@staff_secret_credential.id, ri: "jp"),
        headers: authenticated_headers
