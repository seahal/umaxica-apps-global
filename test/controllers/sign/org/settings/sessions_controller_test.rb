...
class Sign::Org::Settings::SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "destroy_redirect_is_not_session_mutation" do
    ...
    delete sign_org_settings_session_url(other_token.public_id, ri: "jp"), headers: session_headers
  ...
  test "others_redirect_is_not_session_inventory_mutation" do
    ...
    delete sign_org_settings_session_revocations_others_url(ri: "jp"), headers: session_headers
  ...
  test "revoke_all_redirect_is_not_session_mutation" do
    ...
    delete sign_org_settings_session_revocations_all_url(ri: "jp"), headers: session_headers
