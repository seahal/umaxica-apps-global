...
class Sign::Org::Settings::SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "index returns active sessions as JSON" do
    get sign_org_settings_sessions_url(ri: "jp", format: :json),
  ...
  test "index returns HTML by default" do
    get sign_org_settings_sessions_url(ri: "jp"), headers: @headers

    assert_response :success
  end

  test "index requires authentication" do
    get sign_org_settings_sessions_url(ri: "jp"), headers: @unauthenticated_headers
  ...
  test "destroy revokes other session and redirects with see_other" do
    ...
    delete sign_org_settings_session_url(other_token.public_id, ri: "jp"), headers: @headers
  ...
  test "destroy current session returns error redirect instead of revoking" do
    delete sign_org_settings_session_url(@current_token.public_id, ri: "jp"), headers: @headers
  ...
  test "destroy non-existent session returns 404" do
    delete sign_org_settings_session_url("nonexistent_public_id", ri: "jp"), headers: @headers
  ...
  test "destroy requires authentication" do
    ...
    delete sign_org_settings_session_url(other_token.public_id, ri: "jp"),
  ...
  test "destroy does not revoke session belonging to another staff" do
    ...
    delete sign_org_settings_session_url(other_staff_token.public_id, ri: "jp"),
           headers: @headers
  ...
  test "others revokes all sessions except current" do
    ...
    delete others_sign_org_settings_sessions_url(ri: "jp"), headers: @headers
  ...
  test "others requires authentication" do
    delete others_sign_org_settings_sessions_url(ri: "jp"), headers: @unauthenticated_headers
  ...
  test "index shows revoke all other sessions button" do
    ...
    assert_response :success
    assert_select "form[action^='#{others_sign_org_settings_sessions_path}']"
  ...
  test "revoke_all revokes all sessions including current and clears cookies" do
    ...
    delete revoke_all_sign_org_settings_sessions_url(ri: "jp"), headers: @headers
  ...
  test "revoke_all requires authentication" do
    delete revoke_all_sign_org_settings_sessions_url(ri: "jp"), headers: @unauthenticated_headers
  ...
  test "revoke_all records audit event" do
    ...
    assert_equal "Operator", event[:data][:actor_type]
