...
class Sign::Org::Settings::ActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "requires login and preserves ri parameter" do
    get sign_org_settings_activities_url(ri: "jp"), headers: { "Host" => @host }
  ...
  test "shows only current staff activity logs" do
    ...
    get sign_org_settings_activities_url(ri: "jp"), headers: @headers
  ...
  test "shows social unlink events" do
    ...
    assert_includes response.body, I18n.t("sign.org.settings.activity.events.social_unlinked")
  end
