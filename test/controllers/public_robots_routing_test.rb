...
class PublicRobotsRoutingTest < ActionDispatch::IntegrationTest
  ...
  test "public file endpoints respond without redirect" do
    endpoints = [
      ...
      [method(:acme_com_robots_url), ENV.fetch("PRIVATE_ACME_CORPORATE_URL", "www.com.localhost"), "robots"],
      [method(:acme_app_robots_url), ENV.fetch("PRIVATE_ACME_SERVICE_URL", "www.app.localhost"), "robots"],
      [method(:acme_org_robots_url), ENV.fetch("PRIVATE_ACME_STAFF_URL", "www.org.localhost"), "robots"],
      [method(:sign_com_robots_url), ENV.fetch("PRIVATE_SIGN_CORPORATE_URL", "id.com.localhost"), "robots"],
      ...
      [method(:acme_com_sitemap_url), ENV.fetch("PRIVATE_ACME_CORPORATE_URL", "www.com.localhost"), "sitemap"],
      [method(:acme_app_sitemap_url), ENV.fetch("PRIVATE_ACME_SERVICE_URL", "www.app.localhost"), "sitemap"],
      [method(:acme_org_sitemap_url), ENV.fetch("PRIVATE_ACME_STAFF_URL", "www.org.localhost"), "sitemap"],
      [method(:sign_com_sitemap_url), ENV.fetch("PRIVATE_SIGN_CORPORATE_URL", "id.com.localhost"), "sitemap"],
