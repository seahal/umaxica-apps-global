...
class Auth::App::Sign::In::SecretCredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get new" do
    get new_auth_app_sign_in_secret_credential_url(ri: "jp"), headers: default_headers
  ...
  test "server-side Turnstile verifier failure rejects secret credential login" do
    ...
    JitSecurityTurnstileVerifier.stub(:verify, verifier) do
      post(
        auth_app_sign_in_secret_credential_url(ri: "jp"),
  ...
  test "email and matching permanent secret_credential falls back to jp when ri is missing" do
    ...
    post auth_app_sign_in_secret_credential_url,
         params: login_params(identifier: @raw_email, secret_credential_value: raw_secret_credential),
         headers: default_headers
  ...
  test "email and matching permanent secret_credential canonicalizes invalid ri" do
    ...
    post auth_app_sign_in_secret_credential_url(ri: "https://evil.example"),
         params: login_params(identifier: @raw_email, secret_credential_value: raw_secret_credential),
         headers: default_headers

    assert_response :see_other
    assert_redirected_to auth_app_sign_in_secret_credential_url(ri: "jp")
  ...
  test "direct controller branches for mfa and standard secret_credential flows" do
    controller = Auth::App::Sign::In::SecretCredentialsController.new
    session_hash = {}
    ...
    assert_instance_of Auth::App::Sign::In::SecretCredentialsController::SecretLoginForm,
                       controller.instance_variable_get(:@secret_credential_form)

    session_hash[Auth::App::Sign::In::SecretCredentialsController::MFA_USER_SESSION_KEY] = @user.id
    controller.remove_instance_variable(:@mfa_user)
    controller.define_singleton_method(:active_secret_credential_hints_for) { |_| ["hint"] }
    controller.new

    assert_instance_of Auth::App::Sign::In::SecretCredentialsController::MfaSecretForm,
                       controller.instance_variable_get(:@secret_credential_form)
    ...
    controller.define_singleton_method(:verify_secret_credential_for_sign_in) do |user:, raw_secret_credential:|
      Auth::App::Sign::In::SecretCredentialsController::SecretVerificationResult.new(
    ...
    session_hash.delete(Auth::App::Sign::In::SecretCredentialsController::MFA_USER_SESSION_KEY)
  ...
  test "direct controller success handlers cover mfa and standard redirects" do
    ...
    controller.define_singleton_method(:t) { |key| key }
    controller.define_singleton_method(:clear_mfa_session!) { session_hash[Auth::App::Sign::In::SecretCredentialsController::MFA_USER_SESSION_KEY] = nil }
