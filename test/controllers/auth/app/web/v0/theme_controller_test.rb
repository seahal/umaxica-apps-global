...
class Auth::App::Web::V0::ThemeControllerTest < ActionDispatch::IntegrationTest
  ...
  test "GET show without access jwt returns default theme sy" do
    ...
    get auth_app_web_v0_theme_path, as: :json
...
class Auth::App::Web::V0::ThemeControllerTest
