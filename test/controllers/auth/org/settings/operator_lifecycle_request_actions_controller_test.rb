...
class Auth::Org::Settings::OperatorLifecycleRequestActionsControllerTest < ActionDispatch::IntegrationTest
    ...
    browser_headers.merge(
      ...
      "Authorization" => "Bearer #{
        jwt_access_token_for(
          @operator, host: ENV.fetch("PUBLIC_AUTH_STAFF_URL", "auth.org.localhost"),
...
class Auth::Org::Settings::OperatorLifecycleRequestActionsControllerTest
  private
