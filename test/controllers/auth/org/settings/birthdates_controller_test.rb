...
class Auth::Org::Settings::BirthdatesControllerTest
  private
  ...
  def satisfy_staff_verification(staff_token)
    _verification, raw_token = OperatorVerification.issue_for_token!(token: staff_token)
