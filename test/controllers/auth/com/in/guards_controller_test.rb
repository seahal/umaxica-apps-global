...
class Auth::Com::Sign::In::GuardsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "route resolves to guard controller" do
    ...
    assert_equal "auth/com/sign/in/guards", route.fetch(:controller)
  ...
  def build_controller(cycle:, path_target: nil, signed_pt: nil, signed_token: "signed-pt")
    controller = Auth::Com::Sign::In::GuardsController.new
...
class Auth::Com::Sign::In::GuardsControllerTest
  private
