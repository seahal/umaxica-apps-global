...
class Auth::Com::Sign::In::SecretsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "create falls back to jp when ri is missing" do
    post auth_com_sign_in_secret_url,
         params: {
           secret_credential_login_form: {
             identifier: @visitor.visitor_emails.first.address,
             secret_credential_value: @raw_secret_credential,
  ...
  test "create canonicalizes invalid ri" do
    post auth_com_sign_in_secret_url(ri: "https://evil.example"),
         params: {
           secret_credential_login_form: {
             identifier: @visitor.visitor_emails.first.address,
             secret_credential_value: @raw_secret_credential,
    ...
    assert_response :redirect
    assert_includes response.headers["Location"], auth_com_sign_in_secret_url(ri: "jp")
...
class Auth::Com::Sign::In::SecretsControllerTest
