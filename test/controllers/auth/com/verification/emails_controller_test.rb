...
class Auth::Com::Verification::EmailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "direct base controller verification branches" do
    controller = Auth::Com::Verification::BaseController.new
    redirects = []
  ...
  def with_verify_email_otp_stub(result)
    original_method = Auth::Com::Verification::EmailsController.instance_method(:verify_email_otp!)
    Auth::Com::Verification::EmailsController.define_method(:verify_email_otp!) { result }
    yield
  ensure
    Auth::Com::Verification::EmailsController.define_method(:verify_email_otp!, original_method)
  end

  def with_email_nonce_stub(result)
    original_method = Auth::Com::Verification::EmailsController.instance_method(:require_email_nonce!)
    Auth::Com::Verification::EmailsController.define_method(:require_email_nonce!) { result }
    yield
  ensure
    Auth::Com::Verification::EmailsController.define_method(:require_email_nonce!, original_method)
  end
  private
...
class Auth::Com::Verification::EmailsControllerTest
  private
