...
class Side::Org::SettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "show renders the surface's own settings page" do
    ...
    get side_org_settings_path(ri: "jp")

    assert_response :success
    assert_equal "side/org/settings/show", inertia_component
    assert_equal "Settings", inertia_props.fetch("heading")
    assert_match(/Side org control-plane settings/, inertia_props.fetch("description"))
  end
