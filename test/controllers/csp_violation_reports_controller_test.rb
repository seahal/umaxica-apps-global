...
class CspViolationReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  def csp_report_cases
    [
      ...
      [ENV["PRIVATE_BASE_NETWORK_URL"] || ENV.fetch("PRIVATE_BASE_NETWORK_URL", "acme.net.localhost"),
       :acme_network_csp_violation_report_path,],
      [ENV["PRIVATE_BASE_DEVELOPER_URL"] || ENV.fetch("PRIVATE_BASE_DEVELOPER_URL", "acme.dev.localhost"),
