...
class RailsWayHarnessInventoryTest < ActiveSupport::TestCase
  ...
  REVIEWED_MODEL_CONCERN_SIDE_EFFECTS = {
    ...
    "app/models/concerns/passkey_ceremony_transactionable.rb" => [12, "reviewed ceremony transaction model DSL concern"],
    ...
    "app/models/concerns/secret_credential_ceremony_transactionable.rb" => [12, "reviewed ceremony transaction model DSL concern"],
    ...
    "app/models/concerns/social_ceremony_transactionable.rb" => [13, "reviewed ceremony transaction model DSL concern"],
    "app/models/concerns/social_identifiable.rb" => [1, "legacy social identity query concern"],
    "app/models/concerns/step_up_ceremony_transactionable.rb" => [15, "reviewed ceremony transaction model DSL concern"],
    "app/models/concerns/telephone.rb" => [8, "legacy telephone normalization and validation concern"],
    "app/models/concerns/telephone_ceremony_transactionable.rb" => [12, "reviewed ceremony transaction model DSL concern"],
  ...
  REVIEWED_BRANCH_EXCEPTIONS = {
    ...
    "app/models/concerns/step_up_ceremony_transactionable.rb" => [3, "reviewed step-up ceremony transaction branch errors"],
