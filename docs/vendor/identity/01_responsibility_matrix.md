...
| Passkey registration                         | –              | OWN+EXEC             | –    | –    | –    | EXEC    | –                | AUDIT         | IMPL | AUDIT           | Internal Arch           | `app/controllers/sign/app/settings/passkeys_controller.rb`                         | ES256/ES384. TRUSTED_ORIGINS required in production. SIer may not relax origin constraints.                                                                                             |
