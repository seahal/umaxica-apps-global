...
| Sign               | Social                        | GET/POST              | `/social/google/connection`, `/social/apple/connection`, `/social/*/disconnection`, callbacks                    | `sign/app/social/*`                                    | Social linking and callback handling       | Sign ceremony UI; not authorization server                | `config/routes/sign.rb`, `test/integration/routes/sign_route_contract_test.rb` | Social linking is explicit.                                  |
...
| Core               | Web/API/Edge                  | GET/PATCH/POST        | `/web/v0/*`, `/edge/v0/*`, `/api/v0/*`                                                                           | `core/app/*`                                           | Cookie/theme/session/refresh               | Core BFF surface; Acme authority for tokens               | `config/routes/core.rb`, `test/integration/routes/core_route_contract_test.rb` | BFF-style surface.                                           |
