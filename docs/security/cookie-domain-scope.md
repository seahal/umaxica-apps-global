...
| Preference refresh / DBSC / device-id       | `app/controllers/concerns/preference/base.rb` (`preference_cookie_options`)                                    | default `true` | **Apex** (`.example.com`, all subdomains)    | `true`                                                |
| Preference theme/locale, consent flag       | `preference/base.rb:649`, `preference/consented_buffer.rb:24`                                                  | default `true` | **Apex**                                     | `false` (intentionally JS-readable, not a credential) |
