...
| `queue`                 | `config/database.yml` / `POSTGRESQL_QUEUE_PUB`                                         | `development_queue_db`, `test_queue_db`                 | `db/queues_migrate`                                  | infrastructure                            | out of scope                           | Solid Queue writer database; queue operations do not use a read replica.                    |
