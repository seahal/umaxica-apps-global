...
description:
  Builds accessible, performant, visually polished user interfaces that follow the project's design
  system. Use when building or modifying UI components and pages, implementing responsive layouts,
  adding interactivity or component state, or fixing visual and UX issues.
---

# Frontend UI Engineering

The target is UI that reads as the work of a design-aware engineer: real design-system adherence,
proper accessibility, and thoughtful interaction patterns. Left un-steered, generated frontends
converge on a generic house style — overused font families, purple-on-white gradients, predictable
layouts — so take the design direction from the project's own system rather than from defaults.

**Detailed checklist:**
[references/accessibility-checklist.md](references/accessibility-checklist.md) — WCAG 2.1 AA by
principle, testing tools, and the manual checks no tool covers.
...
**Avoid prop drilling deeper than 3 levels.** If you're passing props through components that don't
use them, introduce context or restructure the component tree.
