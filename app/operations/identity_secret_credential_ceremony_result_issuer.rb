...
class IdentitySecretCredentialCeremonyResultIssuer
  ...
  def transaction
    @transaction ||= IdentitySecretCredentialCeremonyReplayStore.for(surface).find_transaction!(grant["transaction_id"])
  end
