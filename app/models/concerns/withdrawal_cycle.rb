...
module WithdrawalCycle
  ...
  included do
    ...
    before_validation :ensure_withdrawal_cycle_reference_defaults
  ...
  def record_withdrawal_event!(from_status_id:, to_status_id:, occurred_at:, token_public_id: nil, reason: nil,
                               metadata: {})
    attrs = {
      withdrawal_cycle_foreign_key => id,
  ...
  def ensure_withdrawal_cycle_reference_defaults
  ...
  def withdrawal_cycle_foreign_key
