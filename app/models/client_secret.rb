...
class ClientSecret < AppPrincipalRecord
  ...
  attribute :user_identity_secret_status_id, default: ClientSecretStatus::ACTIVE
  attribute :user_secret_kind_id, default: ClientSecretKind::LOGIN

  belongs_to :user, class_name: "Client", inverse_of: :client_secrets
  belongs_to :user_secret_status, class_name: "ClientSecretStatus", inverse_of: :client_secrets,
                                  foreign_key: :user_identity_secret_status_id
  belongs_to :user_secret_kind, class_name: "ClientSecretKind", inverse_of: :client_secrets
