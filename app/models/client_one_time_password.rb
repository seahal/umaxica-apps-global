...
class ClientOneTimePassword < AppPrincipalRecord
  ...
  belongs_to :user, class_name: "Client", inverse_of: :client_one_time_passwords
  multi_factor_status_owner :user
  belongs_to :user_one_time_password_status,
             class_name: "ClientOneTimePasswordStatus",
             inverse_of: :client_one_time_passwords,
             foreign_key: :user_identity_one_time_password_status_id
  attribute :user_identity_one_time_password_status_id, default: ClientOneTimePasswordStatus::NOTHING
