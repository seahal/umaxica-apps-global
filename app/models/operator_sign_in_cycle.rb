...
# Indexes
#
#  index_org_sign_in_cycles_on_discarded_at  (discarded_at)
#  index_org_sign_in_cycles_on_expires_at    (expires_at)
#  index_org_sign_in_cycles_on_principal_id  (principal_id)
#  index_org_sign_in_cycles_on_public_id     (public_id) UNIQUE
#  index_org_sign_in_cycles_on_state         (state)
#  index_org_sign_in_cycles_on_status_id     (status_id)
#  index_org_sign_in_cycles_on_token_id      (token_id)
#
# Foreign Keys
#
...
class OperatorSignInCycle < OrgTicketRecord
  self.table_name = "org_sign_in_cycles"
  include SignCycle
  ...
  STEPS = %w(primary mfa session_limit guardrail session_issuance checkpoint dashboard return_to completed
             failed).freeze
  TRANSITIONS = {
    ...
    STATUS_MODEL::GUARDRAIL_PENDING => [STATUS_MODEL::SESSION_ISSUANCE_PENDING, STATUS_MODEL::FAILED],
    STATUS_MODEL::SESSION_ISSUANCE_PENDING => [STATUS_MODEL::CHECKPOINT_PENDING, STATUS_MODEL::FAILED],
    STATUS_MODEL::CHECKPOINT_PENDING => [STATUS_MODEL::DASHBOARD_PENDING, STATUS_MODEL::FAILED],
