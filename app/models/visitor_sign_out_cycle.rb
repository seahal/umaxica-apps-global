...
# == Schema Information
#
# Table name: visitor_sign_out_cycles
...
# Indexes
#
#  index_visitor_sign_out_cycles_on_access_expires_at        (access_expires_at)
#  index_visitor_sign_out_cycles_on_discarded_at             (discarded_at)
#  index_visitor_sign_out_cycles_on_kind_id                  (kind_id)
#  index_visitor_sign_out_cycles_on_principal_id             (principal_id)
#  index_visitor_sign_out_cycles_on_public_id                (public_id) UNIQUE
#  index_visitor_sign_out_cycles_on_purged_at                (purged_at)
#  index_visitor_sign_out_cycles_on_refresh_expires_at       (refresh_expires_at)
#  index_visitor_sign_out_cycles_on_refresh_token_family_id  (refresh_token_family_id)
#  index_visitor_sign_out_cycles_on_status_id                (status_id)
#  index_visitor_sign_out_cycles_on_token_id                 (token_id)
#
# Foreign Keys
#
#  fk_rails_...  (kind_id => visitor_sign_out_cycle_kinds.id)
#  fk_rails_...  (status_id => visitor_sign_out_cycle_statuses.id)
#  fk_rails_...  (token_id => visitor_tokens.id) ON DELETE => cascade
#
class VisitorSignOutCycle < ComTicketRecord
  include SignOutCycle
  include Cycle::SignOut

  STATUS_MODEL = VisitorSignOutCycleStatus
  KIND_MODEL = VisitorSignOutCycleKind
  STATUSES = {
  ...
  belongs_to :status, class_name: "VisitorSignOutCycleStatus"
  belongs_to :kind, class_name: "VisitorSignOutCycleKind"
end
