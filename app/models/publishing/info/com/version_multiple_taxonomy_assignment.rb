  ...
  module Info
    module Com
      class VersionMultipleTaxonomyAssignment < PublishingRecord
        self.table_name = "publishing_info_com_version_multiple_taxonomy_assignments"
        include PublishingFamilyTaxonomyAssignment
        include PublishingTaxonomySnapshot


        belongs_to :entry_version, class_name: "Publishing::Info::Com::EntryVersion", inverse_of: :multiple_taxonomy_assignments
