  ...
  module Info
    module App
      class VersionMultipleTaxonomyAssignment < PublishingRecord
        self.table_name = "publishing_info_app_version_multiple_taxonomy_assignments"
        include Publishing::FamilyTaxonomyAssignment
        include PublishingTaxonomySnapshot


        belongs_to :entry_version, class_name: "Publishing::Info::App::EntryVersion", inverse_of: :multiple_taxonomy_assignments
