  ...
  module Docs
    module App
      class VersionMultipleTaxonomyAssignment < PublishingRecord
        self.table_name = "publishing_docs_app_version_multiple_taxonomy_assignments"
        include PublishingFamilyTaxonomyAssignment
        include PublishingTaxonomySnapshot


        belongs_to :entry_version, class_name: "Publishing::Docs::App::EntryVersion", inverse_of: :multiple_taxonomy_assignments
