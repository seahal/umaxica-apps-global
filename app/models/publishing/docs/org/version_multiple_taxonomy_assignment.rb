  ...
  module Docs
    module Org
      class VersionMultipleTaxonomyAssignment < PublishingRecord
        self.table_name = "publishing_docs_org_version_multiple_taxonomy_assignments"
        include PublishingFamilyTaxonomyAssignment
        include PublishingTaxonomySnapshot


        belongs_to :entry_version, class_name: "Publishing::Docs::Org::EntryVersion", inverse_of: :multiple_taxonomy_assignments
