...
module Publishing
  class Entry < PublishingRecord
    ...
    has_many :publications, class_name: "Publishing::Publication", inverse_of: :entry,
                            dependent: :restrict_with_exception
    has_many :revision_media_usages, class_name: "Publishing::RevisionMediaUsage", inverse_of: :entry,
                                     dependent: :restrict_with_exception
    has_many :version_media_usages, class_name: "Publishing::VersionMediaUsage", inverse_of: :entry,
                                    dependent: :restrict_with_exception
