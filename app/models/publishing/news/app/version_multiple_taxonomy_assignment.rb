  ...
  module News
    module App
      class VersionMultipleTaxonomyAssignment < PublishingRecord
        self.table_name = "publishing_news_app_version_multiple_taxonomy_assignments"
        include PublishingFamilyTaxonomyAssignment
        include PublishingTaxonomySnapshot


        belongs_to :entry_version, class_name: "Publishing::News::App::EntryVersion", inverse_of: :multiple_taxonomy_assignments
