...
# adr/unified-enforcement.md, Principal effects (org realm).
class OrgEnforcementPrincipalEffect < OrgPrincipalRecord
  self.table_name = "org_enforcement_principal_effects"
