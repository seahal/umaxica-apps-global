...
# == Schema Information
#
# Table name: client_sign_out_flows
...
# Indexes
#
#  index_client_sign_out_flows_on_access_expires_at        (access_expires_at)
#  index_client_sign_out_flows_on_discarded_at             (discarded_at)
#  index_client_sign_out_flows_on_kind_id                  (kind_id)
#  index_client_sign_out_flows_on_principal_id             (principal_id)
#  index_client_sign_out_flows_on_public_id                (public_id) UNIQUE
#  index_client_sign_out_flows_on_purged_at                (purged_at)
#  index_client_sign_out_flows_on_refresh_expires_at       (refresh_expires_at)
#  index_client_sign_out_flows_on_refresh_token_family_id  (refresh_token_family_id)
#  index_client_sign_out_flows_on_status_id                (status_id)
#  index_client_sign_out_flows_on_token_id                 (token_id)
#
# Foreign Keys
#
#  fk_rails_...  (kind_id => client_sign_out_flow_kinds.id)
#  fk_rails_...  (status_id => client_sign_out_flow_statuses.id)
...
class ClientSignOutFlow < AppTicketRecord
  ...
  belongs_to :status, class_name: "ClientSignOutFlowStatus"
  belongs_to :kind, class_name: "ClientSignOutFlowKind"
end
