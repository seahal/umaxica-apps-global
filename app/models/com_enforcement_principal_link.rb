...
# adr/unified-enforcement.md, Principal links (com realm).
class ComEnforcementPrincipalLink < ComPrincipalRecord
  self.table_name = "com_enforcement_principal_links"
