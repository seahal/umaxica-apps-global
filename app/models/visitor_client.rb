...
#
class VisitorClient < VisitorRecord
  self.table_name = "client_visitors"

  include ::PublicId

  belongs_to :client_visitor_status,
             class_name: "VisitorClientStatus",
             foreign_key: :status_id,
             inverse_of: :client_visitors
