...
# == Schema Information
#
# Table name: operator_sign_out_cycles
...
# Indexes
#
#  index_operator_sign_out_cycles_on_access_expires_at        (access_expires_at)
#  index_operator_sign_out_cycles_on_discarded_at             (discarded_at)
#  index_operator_sign_out_cycles_on_kind_id                  (kind_id)
#  index_operator_sign_out_cycles_on_principal_id             (principal_id)
#  index_operator_sign_out_cycles_on_public_id                (public_id) UNIQUE
#  index_operator_sign_out_cycles_on_purged_at                (purged_at)
#  index_operator_sign_out_cycles_on_refresh_expires_at       (refresh_expires_at)
#  index_operator_sign_out_cycles_on_refresh_token_family_id  (refresh_token_family_id)
#  index_operator_sign_out_cycles_on_status_id                (status_id)
#  index_operator_sign_out_cycles_on_token_id                 (token_id)
#
# Foreign Keys
#
...
class OperatorSignOutCycle < OrgTicketRecord
  ...
  STATUS_MODEL = OperatorSignOutCycleStatus
  KIND_MODEL = OperatorSignOutCycleKind
  STATUSES = {
  ...
  belongs_to :status, class_name: "OperatorSignOutCycleStatus"
  belongs_to :kind, class_name: "OperatorSignOutCycleKind"
end
