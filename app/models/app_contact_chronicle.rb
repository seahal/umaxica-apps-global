...
#
class AppContactChronicle < ChronicleRecord
  include Retainable
  include Behavior

  belongs_to :app_contact, optional: true, foreign_key: :subject_id, inverse_of: :app_contact_chronicles
  belongs_to :app_contact_chronicle_level, foreign_key: :level_id, inverse_of: :app_contact_chronicles
  belongs_to :app_contact_chronicle_event,
             class_name: "AppContactChronicleEvent",
             foreign_key: "event_id",
             primary_key: "id",
             inverse_of: :app_contact_chronicles
