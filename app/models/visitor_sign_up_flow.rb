...
# == Schema Information
#
# Table name: visitor_sign_up_flows
...
#  index_visitor_sign_up_flows_on_public_id                         (public_id) UNIQUE
#  index_visitor_sign_up_flows_on_state                             (state)
#  index_visitor_sign_up_flows_on_status_id                         (status_id)
#  index_visitor_sign_up_flows_on_status_id_and_expires_at          (status_id,expires_at)
#  index_visitor_sign_up_flows_on_token_id                          (token_id)
#
# Foreign Keys
#
#  fk_rails_...  (cleanup_status_id => visitor_sign_up_flow_cleanup_statuses.id)
#  fk_rails_...  (status_id => visitor_sign_up_flow_statuses.id)
...
class VisitorSignUpFlow < ComTicketRecord
  ...
  belongs_to :status, class_name: "VisitorSignUpFlowStatus"
  belongs_to :cleanup_status, class_name: "VisitorSignUpFlowCleanupStatus", optional: false

  validates :social_provider, absence: true

  def self.cleanup_status_class
    VisitorSignUpFlowCleanupStatus
  end
end
