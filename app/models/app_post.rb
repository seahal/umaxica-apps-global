...
class AppPost < AppPublisherRecord
  ...
  belongs_to :post_status, class_name: "AppPostStatus", inverse_of: :posts
  ...
  has_many :post_reviews, class_name: "AppPostReview", dependent: :restrict_with_error, inverse_of: :post
  has_many :post_versions, class_name: "AppPostVersion", dependent: :delete_all, inverse_of: :post
  has_many :post_revisions, class_name: "AppPostRevision", dependent: :delete_all, inverse_of: :post
  has_many :post_tags, class_name: "AppPostTag", dependent: :delete_all, inverse_of: :post
  has_many :tag_masters, through: :post_tags, source: :post_tag_master
  has_one :category, class_name: "AppPostCategory", dependent: :delete, inverse_of: :post
