  ...
  module Checks
    class Database
      ...
      def call
        ...
        Health::Check::Result.new(kind: :database, status: :ok)
      rescue StandardError => e
        Rails.logger.info(
          Jit::LogEvent.format("health_check.database_failed", error_class: e.class.name),
        )
        Health::Check::Result.new(kind: :database, status: :unready, message: "Dependency unavailable")
      end
