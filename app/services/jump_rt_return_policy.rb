...
module JumpRtReturnPolicy
  ...
  ALLOWED_SOURCES = {
    ...
    "https://core-jp.umaxica.app" => %w(https://core-jp.umaxica.app),
    "https://core-jp.umaxica.com" => %w(https://core-jp.umaxica.com),
    "https://core-jp.umaxica.org" => %w(https://core-jp.umaxica.org),
