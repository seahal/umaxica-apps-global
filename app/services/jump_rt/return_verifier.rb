...
module JumpRt
  class ReturnVerifier
    ...
    def call
      ...
      return failure("invalid_claim") unless JumpRt::ReturnPolicy.allowed_source?(
    ...
    def cached_jwks(force:)
      ...
      fresh
    rescue JWT::DecodeError, JSON::ParserError, SocketError, SystemCallError, Timeout::Error, Net::OpenTimeout,
           Net::ReadTimeout
    ...
    rescue JSON::ParserError, URI::InvalidURIError, SocketError, SystemCallError, Timeout::Error, Net::OpenTimeout,
           Net::ReadTimeout
    ...
    def valid_replay_policy?(value)
      value.blank? || JumpRt::Issuer::VALID_REPLAY_POLICIES.include?(value.to_s)
    end
    ...
    def jump_origin
      JumpRt::ReturnPolicy.normalize_origin(jump_gateway_url)
    end
