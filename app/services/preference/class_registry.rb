...
module Preference
  module ClassRegistry
    ...
    REGISTRY = {
      ...
      "User" => {
        ...
        option_classes: {
          ...
          currency: UserPreferenceCurrencyOption,
          date_format: UserPreferenceDateFormatOption,
          time_format: UserPreferenceTimeFormatOption,
          motion: UserPreferenceMotionOption,
          density: UserPreferenceDensityOption,
          items_per_page: UserPreferenceItemsPerPageOption,
        }.freeze,
        record_classes: {
          ...
          date_format: UserPreferenceDateFormat,
          time_format: UserPreferenceTimeFormat,
          motion: UserPreferenceMotion,
          density: UserPreferenceDensity,
          items_per_page: UserPreferenceItemsPerPage,
        }.freeze,
      }.freeze,
      "Operator" => {
    ...
    def default_option_id(prefix, type)
      ...
      when :motion then option::STANDARD
      when :density then option::STANDARD
