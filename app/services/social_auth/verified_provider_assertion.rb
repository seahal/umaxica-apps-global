...
module SocialAuth
  class VerifiedProviderAssertion
    ...
    def call
      raise ProviderError.new("errors.social_auth.provider_error") unless auth_hash
      raise ProviderError.new("errors.social_auth.provider_error") unless provider == expected_provider
      raise ProviderError.new("errors.social_auth.missing_uid") if uid.blank?
      raise ProviderError.new("errors.social_auth.provider_error") unless credentials_usable?
      raise ProviderError.new("errors.social_auth.provider_error") unless provider_claims_fresh?
