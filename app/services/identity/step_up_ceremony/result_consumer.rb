  ...
  module StepUpCeremony
    class ResultConsumer
      ...
      def validate_result!(result)
        ...
        raise Error, "method is not allowed" unless transaction.allowed_methods_array.include?(result["method"].to_s)
        raise Error, "AAL is insufficient" unless aal_rank(result["aal"]) >= aal_rank(transaction.required_aal)
      end
      ...
      def consume_result!(result)
        ...
        raise Error, "durable step-up ceremony transaction is required"
      end
    end
  end
end
