  ...
  module TelephoneCeremony
    class FinalCommitter
      ...
      def validate_candidate_before_consumption!
        raise Error, "telephone candidate is already verified" unless status_value == config.fetch(:unverified_status)
        raise Error,
      ...
      def commit_candidate!
        config.fetch(:record_class).transaction do
          ...
          raise Error, "telephone candidate is already verified" unless locked.public_send(config.fetch(:status_key)) ==
      ...
      def find_candidate!
        ...
        raise Error, "telephone candidate is required" if candidate_ref.blank?
