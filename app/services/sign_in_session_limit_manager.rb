...
class SignInSessionLimitManager
  ...
  SignInResult = Struct.new(:cycle, :token, :refresh_token, keyword_init: true)
  ...
  def promote!
    ...
    cycle.class.transaction do
      ...
      SignInResult.new(cycle: cycle, token: nil, refresh_token: nil)
    end
  end
