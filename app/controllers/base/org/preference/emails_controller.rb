...
module Base
  module Org
    module Preference
      ...
      class EmailsController < ::Base::Org::BareController
        ...
        def unsubscribe_page_props
...

          {
            ...
            description:
              if promotional
                t("base.org.preference.emails.unsubscribe.description")
              else
                t("base.org.preference.emails.unsubscribe.disabled_description")
              end,
        ...
        def unsubscribe_form_props
          ...
          {
            action: base_org_preference_email_path(@email),
        ...
        def redirect_after_unsubscribe_path(token:)
          edit_base_org_preference_email_path(@email, token: token)
        end
      end
    end
  end
