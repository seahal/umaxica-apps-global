...
module Base
  module Com
    module Identity
      class WithdrawalSessionsController < ::Base::Com::ApplicationController
        ...
        rate_limit(
          ...
          only: :create,
          with: -> { render_rate_limited(rule_name: "base_com_withdrawal_reentry_email_create_ip_burst", retry_after: 60) },
        )
