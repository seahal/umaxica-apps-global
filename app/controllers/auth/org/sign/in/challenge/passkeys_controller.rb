        ...
        module Challenge
          class PasskeysController < ::Auth::Org::ApplicationController
            ...
            rate_limit(
              ...
              only: :create,
              with: -> {
                render_rate_limited(rule_name: "sign_org_sign_in_mfa_passkey_create_ip_burst", retry_after: 60)
              },
            )
            rate_limit(
              to: 20,
              ...
              only: :create,
              with: -> {
                render_rate_limited(rule_name: "sign_org_sign_in_mfa_passkey_create_ip_sustained", retry_after: 900)
              },
            )
            ...
            def new
              ...
              if passkeys.empty?
                redirect_to(
                  sign_org_sign_in_challenge_path,
              ...
              redirect_to(
                sign_org_sign_in_challenge_path, alert: I18n.t("errors.webauthn.origin_invalid"),
                                                 status: :see_other,
              )
            end
            ...
            def create
              unless cloudflare_turnstile_stealth_validation["success"]
                redirect_to(
                  new_sign_org_sign_in_challenge_passkey_path,
              ...
              redirect_to(
                sign_org_sign_in_challenge_path, alert: I18n.t("errors.webauthn.challenge_invalid"),
                                                 status: :see_other,
              )
            rescue WebAuthn::SignCountVerificationError
              redirect_to(
                sign_org_sign_in_challenge_path, alert: I18n.t("errors.webauthn.sign_count_mismatch"),
                                                 status: :see_other,
              )
            rescue WebAuthn::Error
              redirect_to(
                sign_org_sign_in_challenge_path, alert: I18n.t("errors.webauthn.verification_failed"),
                                                 status: :see_other,
              )
            end
