...
module Auth
  module Org
    module Settings
      class ActivitiesController < ::Auth::Org::FullAccessController
        ...
        def index
          ...
          render "auth/org/settings/activities/index"
        ...
        def activity_log = @activity_log ||= ::Auth::Org::Settings::ActivityLog.new(current_operator)
