...
module Auth
  module Com
    module Settings
      class ActivitiesController < ::Auth::Com::FullAccessController
        ...
        def index
          ...
          render "auth/com/settings/activities/index"
        ...
        def activity_log = @activity_log ||= ::Auth::Com::Settings::ActivityLog.new(current_visitor)
