...
# The `resend` action was split out of Auth::App::Verification::EmailsController into this
...
class Auth::App::Verification::RedeliveriesController < ::Auth::App::Verification::BaseController
