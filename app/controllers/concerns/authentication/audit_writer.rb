...
module Authentication
  ...
  #      `Chronicle::FallbackRecorder`, which renders a structured log
  ...
  #   Authentication::AuditWriter.write!(audit_class, event_id, resource:, ...)
  #
  ...
  class AuditWriter
    ...
    def self.enqueue_outbox_fallback!(event_uuid:, audit_class:, event_id:, resource:, actor:, ip_address:, context:,
      ...
      payload = {
        ...
        ip_address: ip_address,
        context: Chronicle::Recorder.sanitize(context_hash(context)),
