  ...
  module TotpCeremonyDelegation
    ...
    def accept_totp_ceremony_grant!(surface:)
      ...
      grant = Identity::TotpCeremony::Grant.decode(
        token,
        issuer_id: Identity::TotpCeremony::Contract.acme_issuer_id(surface),
      )
      session[totp_ceremony_session_key] = {
        "grant" => token,
      ...
      true
    rescue Identity::TotpCeremony::Error
      false
    end
    ...
    def finish_totp_ceremony!(surface:, actor:, session_ref:, private_key:, title:, last_otp_at:,
      ...
      candidate = Identity::TotpCeremony::CandidateStore.store!(
        surface: surface,
        actor_ref: actor.public_id,
        session_ref: session_ref,
      ...
      result_token = Identity::TotpCeremony::ResultIssuer.issue!(
