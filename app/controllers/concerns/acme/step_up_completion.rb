...
module Acme
  module StepUpCompletion
    ...
    def complete_step_up_ceremony!(surface:, actor:, token:, fallback:)
      ...
      payload = Identity::StepUpCeremony::Contract.decode_unverified_payload(result_token)
      ...
      raise Identity::StepUpCeremony::Error,
      ...
      consumption = Identity::StepUpCeremony::ResultConsumer.new(transaction: transaction, now: now).call(result_token)
    ...
    rescue KeyError, ActiveRecord::RecordNotFound, Identity::StepUpCeremony::Error => e
      Rails.logger.info(
        Jit::LogEvent.format(
