...
module ReadOnlyContentRendering
  ...
  def render_content_show
    @content_entry = content_entry_class.published.for_locale(content_locale).find_by!(slug: params[:slug])
  ...
  def render_content_api_show
    entry = content_entry_class.published.for_locale(content_locale).find_by!(slug: params[:slug])
  ...
  def content_entry_class
    @content_entry_class ||= "#{content_namespace.to_s.camelize}::#{content_surface.to_s.camelize}::ContentEntry".constantize
  end
