    ...
    module Configuration
      class SecretCredentialsController < Sign::App::ApplicationController
        ...
        def create
          ...
          redirect_to(sign_app_configuration_secret_credentials_path)
        ...
        def update
          ...
          if disabling_secret_credential? && AuthMethodGuard.last_method?(current_client, excluding: @secret_credential)
            ...
            return redirect_to(sign_app_configuration_secret_credentials_path(ri: params[:ri]))
          end
          ...
          redirect_to(sign_app_configuration_secret_credentials_path(ri: params[:ri]))
        rescue ActiveRecord::RecordInvalid => e
        ...
        def destroy
          ...
          if AuthMethodGuard.last_method?(current_client, excluding: @secret_credential)
            flash[:alert] = t(".last_method")
            return redirect_to(sign_app_configuration_secret_credentials_path)
          end

          ClientSecretCredentials::Destroy.call(actor: current_client, secret_credential: @secret_credential)
          flash[:notice] = t(".destroyed")
          redirect_to(sign_app_configuration_secret_credentials_path, status: :see_other)
        end
        ...
        def regenerate
          authorize!(@secret_credential)
          redirect_to(
            sign_app_configuration_secret_credential_path(@secret_credential.public_id),
        ...
        def secret_credential_turnstile_failure_redirect_path
          sign_app_configuration_secret_credentials_path(ri: params[:ri])
        end
