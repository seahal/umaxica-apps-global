...
module Sign
  module App
    module Up
      module Check
        module Email
          class OtpsController < ::Sign::App::Up::EmailsController
            ...
            def show
              ...
              render "sign/app/up/emails/edit"
            end
            ...
            def render_otp_ceremony_result(result)
              if result.status == :rate_limited
                ...
                return render "sign/app/up/emails/edit", status: :too_many_requests
              end

              @user_email.errors.add(:pass_code, t("sign.app.registration.email.update.invalid_code"))
              render "sign/app/up/emails/edit", status: :unprocessable_content
            end
            ...
            def handle_locked_result
              ...
              render "sign/app/up/emails/edit", status: :too_many_requests
            end
          end
        end
      end
