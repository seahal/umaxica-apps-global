...
module Sign
  module App
    module Up
      module Check
        module Telephone
          class PasscodesController < Sign::App::Up::Checkpoint::PasscodesController
            ...
            def show
              ...
              render "sign/app/up/checkpoint/passcodes/new"
            end
            ...
            def update
              ...
              redirect_to(sign_app_up_check_telephone_birthdate_path(ri: params[:ri], pt: signed_pt_param))
            rescue ActiveRecord::RecordInvalid => e
              @secret_credential = e.record
              @raw_secret_credential = session[passcode_registration_raw_session_key]
              render "sign/app/up/checkpoint/passcodes/new", status: :unprocessable_content
            end
