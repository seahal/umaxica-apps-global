...
module Sign
  module Com
    class SignOutsController < Sign::Com::ApplicationController
      ...
      def show
        ...
        redirect_to(edit_sign_com_sign_out_path(ri: params[:ri]))
      end
      ...
      def create
        unless ActiveModel::Type::Boolean.new.cast(params[:confirm])
          redirect_to(
            ...
            alert: t("views.sign.sign_outs.edit.confirm_label"),
          )
          return
        end
