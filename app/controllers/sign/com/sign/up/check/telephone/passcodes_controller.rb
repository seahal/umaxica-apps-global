          ...
          module Telephone
            class PasscodesController < ::Sign::Com::ApplicationController
              ...
              def show
                ...
                render "sign/com/sign/up/checkpoint/passcodes/new"
              end
              ...
              def update
                ...
                redirect_to(sign_com_sign_up_check_telephone_birthdate_path(ri: params[:ri], pt: signed_pt_param))
              rescue ActiveRecord::RecordInvalid => e
                @secret_credential = e.record
                @raw_secret_credential = session[passcode_registration_raw_session_key]
                render "sign/com/sign/up/checkpoint/passcodes/new", status: :unprocessable_content
              end
