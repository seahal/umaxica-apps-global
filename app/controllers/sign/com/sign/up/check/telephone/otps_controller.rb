  ...
  module Com
    module Sign
      module Up
        module Check
          module Telephone
            class OtpsController < ::Sign::Com::Sign::Up::TelephonesController
              ...
              def show
                if dummy_existing_telephone_flow?
                  ...
                  return render "sign/com/sign/up/telephones/edit" if valid_telephone_session?
                ...
                render "sign/com/sign/up/telephones/edit"
              end
              ...
              def render_otp_ceremony_result(result)
                if result.status == :rate_limited
                  ...
                  return render "sign/com/sign/up/telephones/edit", status: :too_many_requests
                end
