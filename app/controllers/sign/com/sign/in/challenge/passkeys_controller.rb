        ...
        module Challenge
          class PasskeysController < ::Sign::Com::ApplicationController
            ...
            rate_limit(
              ...
              only: :create,
              with: -> {
                render_rate_limited(rule_name: "sign_com_sign_in_mfa_passkey_create_ip_burst", retry_after: 60)
              },
            )
            rate_limit(
              to: 20,
              ...
              only: :create,
              with: -> {
                render_rate_limited(rule_name: "sign_com_sign_in_mfa_passkey_create_ip_sustained", retry_after: 900)
              },
            )
            ...
            def new
              ...
              if passkeys.empty?
                redirect_to(
                  sign_com_sign_in_challenge_path(ri: current_region_identifier),
            ...
            def create
              unless cloudflare_turnstile_stealth_validation["success"]
                redirect_to(
                  new_sign_com_sign_in_challenge_passkey_path(ri: current_region_identifier),
