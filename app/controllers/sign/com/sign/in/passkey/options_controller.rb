...
module Sign
  module Com
    module Sign
      module In
        module Passkey
          class OptionsController < ::Sign::Com::ApplicationController
            ...
            rate_limit(
              ...
              with: -> { render_rate_limited(rule_name: "sign_com_sign_in_passkey_options_ip_burst", retry_after: 60) },
            )
            rate_limit(
              to: 20,
              within: 15.minutes,
              ...
              store: rate_limit_store,
              with: -> {
                render_rate_limited(rule_name: "sign_com_sign_in_passkey_options_ip_sustained", retry_after: 900)
              },
            )
            ...
            def perform_passkey_sign_in(passkey)
              ...
              establish_signed_in_session!(
                passkey.visitor, pt: pt, ri: params[:ri], auth_method: "passkey",
              )
            end
