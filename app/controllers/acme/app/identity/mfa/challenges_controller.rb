      ...
      module Mfa
        class ChallengesController < BaseController
          ...
          def show
            ...
            render "sign/app/settings/mfa/challenges/show"
          end
          ...
          def update
            ...
            redirect_to(
              acme_app_identity_mfa_challenge_path(ri: params[:ri]),
            ...
            render "sign/app/settings/mfa/challenges/show", status: :unprocessable_content
          end
