      ...
      module Telephones
        class RegistrationsController < BaseController
          ...
          def new
            ...
            render "sign/app/settings/telephones/registrations/new"
          end
          ...
          def edit
            ...
            unless valid_registration_session?
              reset_registration_session!
              return redirect_to(
                new_acme_app_identity_telephones_registration_path,
                notice: t("sign.app.registration.telephone.edit.session_expired"),
              )
            end
            render "sign/app/settings/telephones/registrations/edit"
          end
          ...
          def create
            ...
            redirect_to(
              edit_acme_app_identity_telephones_registration_path,
          ...
          def handle_registration_update_status(status)
            ...
            when :success
              ...
              reset_registration_session!
              redirect_to(
                acme_app_identity_telephones_url(
                  ri: params[:ri],
                  host: ENV.fetch(
                    "ACME_SERVICE_URL",
                    "www.app.localhost",
