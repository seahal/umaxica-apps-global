      ...
      class TelephonesController < BaseController
        ...
        def create
          ...
          if initiate_telephone_verification(user, number, auto_accept_confirmations: true)
            redirect_to(edit_acme_app_identity_telephones_registration_path(ri: params[:ri]), status: :see_other)
          else
        ...
        def destroy
          ...
          authorize!(telephone)
          return redirect_to(
            acme_app_identity_telephones_path(ri: params[:ri]),
            status: :see_other,
          ...
          telephone.destroy!
          redirect_to(acme_app_identity_telephones_path(ri: params[:ri]), status: :see_other)
        end
