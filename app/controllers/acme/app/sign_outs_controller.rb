  ...
  module App
    class SignOutsController < Acme::App::ApplicationController
      ...
      def show
        ...
        return render "sign/app/sign_outs/show" if @sign_out_notice.present?

        redirect_to(edit_acme_app_sign_out_path(ri: params[:ri]))
      end

      def edit
        render "sign/app/sign_outs/edit"
      end
      ...
      def perform_sign_out!
        ...
        render "sign/app/sign_outs/show"
      end
