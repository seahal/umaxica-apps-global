  ...
  module Org
    module Settings
      class SessionsController < Acme::Org::ApplicationController
        ...
        def index
          super
          render "sign/org/settings/sessions/index" unless performed?
        end
        ...
        def render_revoke_success
          redirect_to(
            acme_org_settings_sessions_path,
            status: :see_other,
        ...
        def render_current_session_error
          redirect_to(acme_org_settings_sessions_path, alert: t("sign.org.in.session.cannot_revoke_current"))
        end
      end
    end
  end
