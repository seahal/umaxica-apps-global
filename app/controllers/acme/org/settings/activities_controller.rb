    ...
    module Settings
      class ActivitiesController < Acme::Org::FullAccessController
        ...
        def index
          ...
          render "acme/org/settings/activities/index"
        ...
        def activity_event_label(activity)
          ...
          return t("sign.org.settings.activity.events.unknown", event_id: activity.event_id) if key.blank?

          I18n.t("sign.org.settings.activity.events." + key)
        end
