  ...
  module Org
    class SignOutsController < Acme::Org::ApplicationController
      ...
      def show
        ...
        return render "sign/org/sign_outs/show" if @sign_out_notice.present?

        redirect_to(edit_acme_org_sign_out_path(ri: params[:ri]))
      end

      def edit
        render "sign/org/sign_outs/edit"
      end
      ...
      def perform_sign_out!
        ...
        render "sign/org/sign_outs/show"
      end
