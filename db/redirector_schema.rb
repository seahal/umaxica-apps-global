...
ActiveRecord::Schema[8.2].define(version: 2026_05_18_044610) do
  ...
  create_table "app_jump_links", force: :cascade do |t|
    ...
    t.index ["purged_at"], name: "index_app_jump_links_on_purged_at"
  ...
  create_table "com_jump_links", force: :cascade do |t|
    ...
    t.index ["purged_at"], name: "index_com_jump_links_on_purged_at"
  ...
  create_table "org_jump_links", force: :cascade do |t|
    ...
    t.index ["purged_at"], name: "index_org_jump_links_on_purged_at"
