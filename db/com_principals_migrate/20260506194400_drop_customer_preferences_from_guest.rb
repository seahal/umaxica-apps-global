...
#   1. All customer_preferences data has been migrated to com_preference DB
#   2. Application code has been updated to use the current Com preference connection
