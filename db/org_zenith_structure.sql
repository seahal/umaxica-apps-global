...
--
-- Name: index_operators_on_webauthn_user_handle; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_operators_on_webauthn_user_handle ON public.operators USING btree (webauthn_user_handle);
