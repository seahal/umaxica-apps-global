...
ActiveRecord::Schema[8.2].define(version: 2026_05_20_143004) do
  ...
  create_table "app_preference_chronicles", force: :cascade do |t|
    ...
    t.text "current_value", default: "", null: false
    t.bigint "event_id", default: 0, null: false
    t.datetime "purged_at", default: -> { "(CURRENT_TIMESTAMP + 'P7Y'::interval)" }, null: false
    t.inet "ip_address", default: "0.0.0.0", null: false
    t.bigint "level_id", default: 0, null: false
    t.datetime "occurred_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.text "previous_value", default: "", null: false
    ...
    t.index ["purged_at"], name: "index_app_preference_chronicles_on_purged_at"
  ...
  create_table "chronicle_outbox_entries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chronicle_id"], name: "index_chronicle_outbox_entries_on_chronicle_id"
    t.index ["event_uuid"], name: "index_chronicle_outbox_entries_on_event_uuid"
    t.index ["status"], name: "index_chronicle_outbox_entries_on_status"
  end

  create_table "chronicle_retention_policies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_chronicle_retention_policies_on_code", unique: true
    t.check_constraint "permanent = false OR duration_days = 0", name: "chk_chronicle_retention_policies_permanent_duration"
  end

  create_table "chronicle_visibilities", force: :cascade do |t|
    t.bigint "chronicle_id", null: false
    t.bigint "chronicle_visibility_context_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chronicle_id", "chronicle_visibility_context_id"], name: "idx_chronicle_visibilities_unique_context", unique: true
    t.index ["chronicle_id"], name: "index_chronicle_visibilities_on_chronicle_id"
    t.index ["chronicle_visibility_context_id"], name: "idx_on_chronicle_visibility_context_id_2c36ec5eab"
  end

  create_table "chronicle_visibility_contexts", force: :cascade do |t|
    t.string "code", null: false
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_chronicle_visibility_contexts_on_code", unique: true
  end
  ...
  create_table "chronicles", force: :cascade do |t|
    ...
    t.bigint "subject_id"
    t.bigint "chronicle_retention_policy_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action"], name: "index_chronicles_on_action"
    t.index ["actor_type", "actor_id"], name: "index_chronicles_on_actor"
    t.index ["chronicle_retention_policy_id"], name: "index_chronicles_on_chronicle_retention_policy_id"
    t.index ["erasable_at"], name: "index_chronicles_on_erasable_at"
    t.index ["event_uuid"], name: "index_chronicles_on_event_uuid", unique: true
    t.index ["occurred_at"], name: "index_chronicles_on_occurred_at"
  ...
  create_table "client_chronicle_levels", force: :cascade do |t|
  end

  create_table "client_chronicles", force: :cascade do |t|
    t.bigint "actor_id", default: 0, null: false
    t.text "actor_type", default: "", null: false
    t.jsonb "context", default: {}, null: false
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.datetime "discarded_at", default: ::Float::INFINITY, null: false
    t.index ["actor_id", "occurred_at"], name: "index_client_chronicles_on_actor_id_and_occurred_at"
    t.index ["actor_type", "actor_id"], name: "index_user_activities_on_actor"
    t.index ["event_id"], name: "index_client_chronicles_on_event_id"
    t.index ["level_id"], name: "index_client_chronicles_on_level_id"
    t.index ["occurred_at"], name: "index_client_chronicles_on_occurred_at"
    t.index ["purged_at"], name: "index_client_chronicles_on_purged_at"
    t.index ["subject_id"], name: "index_client_chronicles_on_subject_id"
  ...
  create_table "com_preference_chronicles", force: :cascade do |t|
    ...
    t.index ["purged_at"], name: "index_com_preference_chronicles_on_purged_at"
  ...
  create_table "operator_chronicle_events", force: :cascade do |t|
  end

  create_table "operator_chronicle_levels", force: :cascade do |t|
  end

  create_table "operator_chronicles", force: :cascade do |t|
    t.bigint "actor_id", default: 0, null: false
    t.text "actor_type", default: "", null: false
    t.jsonb "context", default: {}, null: false
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.datetime "discarded_at", default: ::Float::INFINITY, null: false
    t.index ["actor_id", "occurred_at"], name: "index_operator_chronicles_on_actor_id_and_occurred_at"
    t.index ["actor_type", "actor_id"], name: "index_staff_activities_on_actor"
    t.index ["event_id"], name: "index_operator_chronicles_on_event_id"
    t.index ["level_id"], name: "index_operator_chronicles_on_level_id"
    t.index ["occurred_at"], name: "index_operator_chronicles_on_occurred_at"
    t.index ["purged_at"], name: "index_operator_chronicles_on_purged_at"
    t.index ["subject_id"], name: "index_operator_chronicles_on_subject_id"
  ...
  create_table "org_preference_chronicles", force: :cascade do |t|
    ...
    t.index ["purged_at"], name: "index_org_preference_chronicles_on_purged_at"
  ...
  add_foreign_key "chronicle_outbox_entries", "chronicles"
  add_foreign_key "chronicle_visibilities", "chronicle_visibility_contexts"
  add_foreign_key "chronicle_visibilities", "chronicles"
  add_foreign_key "chronicles", "chronicle_retention_policies"
  add_foreign_key "client_chronicles", "client_chronicle_events", column: "event_id", validate: false
  add_foreign_key "client_chronicles", "client_chronicle_levels", column: "level_id", validate: false
  ...
  add_foreign_key "operator_chronicles", "operator_chronicle_events", column: "event_id", validate: false
  add_foreign_key "operator_chronicles", "operator_chronicle_levels", column: "level_id", validate: false
