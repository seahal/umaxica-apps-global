...
ActiveRecord::Schema[8.2].define(version: 2026_05_20_072158) do
  ...
  create_table "staff_chronicles", force: :cascade do |t|
    ...
    t.index ["purged_at"], name: "index_staff_chronicles_on_purged_at"
  ...
  create_table "user_chronicles", force: :cascade do |t|
    ...
    t.index ["purged_at"], name: "index_user_chronicles_on_purged_at"
