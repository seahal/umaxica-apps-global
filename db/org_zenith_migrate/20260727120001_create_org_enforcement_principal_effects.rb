...
class CreateOrgEnforcementPrincipalEffects < ActiveRecord::Migration[8.2]
  def up
    create_table(:org_enforcement_principal_effects) do |t|
      ...
      t.index(%i(principal_public_id ended_at), name: "idx_org_enforcement_principal_effects_principal_open")
    end
  end

  def down
    drop_table(:org_enforcement_principal_effects)
  end
end
