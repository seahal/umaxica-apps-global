...
--
-- Name: index_clients_on_webauthn_user_handle; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_clients_on_webauthn_user_handle ON public.clients USING btree (webauthn_user_handle);
