...
--
-- Name: index_avatar_role_permissions_on_avatar_role_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_avatar_role_permissions_on_avatar_role_id ON public.avatar_role_permissions USING btree (avatar_role_id);
...
ALTER TABLE ONLY public.avatar_mutes
    ADD CONSTRAINT fk_rails_23710bcc08 FOREIGN KEY (muter_avatar_id) REFERENCES public.avatars(id);
...
ALTER TABLE ONLY public.avatar_blocks
    ADD CONSTRAINT fk_rails_8250386a91 FOREIGN KEY (blocker_avatar_id) REFERENCES public.avatars(id);
...
ALTER TABLE ONLY public.avatar_blocks
    ADD CONSTRAINT fk_rails_903ed2c4c2 FOREIGN KEY (blocked_avatar_id) REFERENCES public.avatars(id);
...
ALTER TABLE ONLY public.avatar_mutes
    ADD CONSTRAINT fk_rails_c0a7894e9b FOREIGN KEY (muted_avatar_id) REFERENCES public.avatars(id);
