...
--
-- Name: operator_token_usages; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.operator_token_usages (
    id bigint NOT NULL,
...
--
-- Name: operator_token_usages_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.operator_token_usages_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: operator_token_usages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.operator_token_usages_id_seq OWNED BY public.operator_token_usages.id;
...
--
-- Name: operator_token_usages id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.operator_token_usages ALTER COLUMN id SET DEFAULT nextval('public.operator_token_usages_id_seq'::regclass);
...
--
-- Name: operator_token_usages operator_token_usages_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.operator_token_usages
    ADD CONSTRAINT operator_token_usages_pkey PRIMARY KEY (id);
...
--
-- Name: idx_active_operator_token_usage_per_rp; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_active_operator_token_usage_per_rp ON public.operator_token_usages USING btree (operator_token_id, oidc_client_id) WHERE (revoked_at IS NULL);
...
--
-- Name: index_operator_authorization_codes_on_operator_token_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_operator_authorization_codes_on_operator_token_id ON public.operator_authorization_codes USING btree (operator_token_id);
...
--
-- Name: index_operator_token_usages_on_oidc_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_operator_token_usages_on_oidc_client_id ON public.operator_token_usages USING btree (oidc_client_id);


--
-- Name: index_operator_token_usages_on_operator_token_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_operator_token_usages_on_operator_token_id ON public.operator_token_usages USING btree (operator_token_id);


--
-- Name: index_operator_token_usages_on_public_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_operator_token_usages_on_public_id ON public.operator_token_usages USING btree (public_id);


--
-- Name: index_operator_token_usages_on_refresh_token_digest; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_operator_token_usages_on_refresh_token_digest ON public.operator_token_usages USING btree (refresh_token_digest) WHERE (refresh_token_digest IS NOT NULL);


--
-- Name: index_operator_token_usages_on_revoked_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_operator_token_usages_on_revoked_at ON public.operator_token_usages USING btree (revoked_at);
...
--
-- Name: operator_token_usages fk_rails_0ed5c922e1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.operator_token_usages
    ADD CONSTRAINT fk_rails_0ed5c922e1 FOREIGN KEY (operator_token_id) REFERENCES public.operator_tokens(id) ON DELETE CASCADE;
...
--
-- Name: operator_authorization_codes fk_rails_6ba8af8d1d; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.operator_authorization_codes
    ADD CONSTRAINT fk_rails_6ba8af8d1d FOREIGN KEY (operator_token_id) REFERENCES public.operator_tokens(id) ON DELETE CASCADE NOT VALID;
