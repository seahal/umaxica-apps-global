...
ActiveRecord::Schema[8.2].define(version: 2026_05_20_190001) do
  ...
  create_table "device_sessions", force: :cascade do |t|
    ...
    t.index ["staff_id"], name: "index_device_sessions_on_staff_id"
  end
  ...
  create_table "org_sign_in_cycles", force: :cascade do |t|
    t.string "public_id", limit: 21, null: false
    t.bigint "principal_id"
    t.bigint "token_id"
    ...
    t.datetime "updated_at", null: false
    t.bigint "status_id", default: 10, null: false
    t.index ["discarded_at"], name: "index_org_sign_in_cycles_on_discarded_at"
    t.index ["expires_at"], name: "index_org_sign_in_cycles_on_expires_at"
    t.index ["principal_id"], name: "index_org_sign_in_cycles_on_principal_id"
    t.index ["public_id"], name: "index_org_sign_in_cycles_on_public_id", unique: true
    t.index ["state"], name: "index_org_sign_in_cycles_on_state"
    t.index ["status_id"], name: "index_org_sign_in_cycles_on_status_id"
    t.index ["token_id"], name: "index_org_sign_in_cycles_on_token_id"
  ...
  create_table "org_sign_up_cycles", force: :cascade do |t|
    t.string "public_id", limit: 21, null: false
    t.bigint "principal_id"
    t.bigint "token_id"
    t.string "state", null: false
    ...
    t.datetime "updated_at", null: false
    t.bigint "status_id", default: 10, null: false
    t.index ["discarded_at"], name: "index_org_sign_up_cycles_on_discarded_at"
    t.index ["expires_at"], name: "index_org_sign_up_cycles_on_expires_at"
    t.index ["principal_id"], name: "index_org_sign_up_cycles_on_principal_id"
    t.index ["public_id"], name: "index_org_sign_up_cycles_on_public_id", unique: true
    t.index ["state"], name: "index_org_sign_up_cycles_on_state"
    t.index ["status_id"], name: "index_org_sign_up_cycles_on_status_id"
    t.index ["token_id"], name: "index_org_sign_up_cycles_on_token_id"
  ...
  create_table "staff_oidc_connections", force: :cascade do |t|
    t.string "public_id", limit: 21, null: false
    t.bigint "staff_id", null: false
    t.string "client_id", limit: 64, null: false
    t.string "scope"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["public_id"], name: "index_staff_oidc_connections_on_public_id", unique: true
    t.index ["staff_id", "client_id"], name: "index_staff_oidc_connections_on_staff_id_and_client_id", unique: true
    t.index ["staff_id"], name: "index_staff_oidc_connections_on_staff_id"
  end

  create_table "staff_step_up_sessions", force: :cascade do |t|
    ...
    t.index ["staff_token_id"], name: "index_staff_step_up_sessions_on_staff_token_id", unique: true
  end

  add_check_constraint "staff_step_up_sessions", "discarded_at <= purged_at", name: "chk_staff_step_up_sessions_retention_order", validate: false
  ...
  create_table "staff_tokens", force: :cascade do |t|
    ...
    t.index ["created_at"], name: "index_staff_tokens_on_created_at"
    ...
    t.index ["device_session_id"], name: "index_staff_tokens_on_device_session_id"
    t.index ["discarded_at"], name: "index_staff_tokens_on_discarded_at"
    t.index ["oidc_connection_id"], name: "index_staff_tokens_on_oidc_connection_id"
    t.index ["oidc_jti"], name: "index_staff_tokens_on_oidc_jti"
    t.index ["oidc_sid"], name: "index_staff_tokens_on_oidc_sid"
    t.index ["public_id"], name: "index_staff_tokens_on_public_id", unique: true
    t.index ["purged_at"], name: "index_staff_tokens_on_purged_at"
    ...
    t.index ["rotated_at"], name: "index_staff_tokens_on_rotated_at"
    t.index ["staff_id", "last_step_up_at"], name: "index_staff_tokens_on_staff_id_and_last_step_up_at"
    t.index ["staff_id", "oidc_client_id"], name: "index_staff_tokens_on_staff_id_and_oidc_client_id"
  ...
  add_foreign_key "operator_sign_out_cycles", "staff_tokens", column: "token_id", on_delete: :cascade, validate: false
  add_foreign_key "org_sign_in_cycles", "operator_sign_in_cycle_statuses", column: "status_id", validate: false
  add_foreign_key "org_sign_in_cycles", "staff_tokens", column: "token_id", on_delete: :cascade, validate: false
  add_foreign_key "org_sign_up_cycles", "operator_sign_up_cycle_statuses", column: "status_id", validate: false
  add_foreign_key "org_sign_up_cycles", "staff_tokens", column: "token_id", on_delete: :cascade, validate: false
  add_foreign_key "staff_step_up_sessions", "staff_tokens", on_delete: :cascade, validate: false
