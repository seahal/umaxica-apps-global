...
class RenameStaffPasskeyStatusIdToStatusId < ActiveRecord::Migration[8.2]
  ...
  def up
    safety_assured do
      rename_status_column(
        ...
        status_table: :staff_passkey_statuses,
        old_column: :staff_passkey_status_id,
        new_column: :status_id,
        old_index_name: "index_staff_passkeys_on_staff_passkey_status_id",
        new_index_name: "index_staff_passkeys_on_status_id",
      )
    end
  end
  ...
  def down
    safety_assured do
      rename_status_column(
        ...
        new_column: :staff_passkey_status_id,
        old_index_name: "index_staff_passkeys_on_status_id",
        new_index_name: "index_staff_passkeys_on_staff_passkey_status_id",
      )
    end
  end
