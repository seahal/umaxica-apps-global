...
# Adds a coarse, privacy-preserving network fingerprint to client device
...
class AddLastNetworkHmacToClientDeviceSessions < ActiveRecord::Migration[8.2]
  disable_ddl_transaction!

  def change
    add_column :client_device_sessions, :last_network_hmac, :string
  end
end
