class CreateAppSignSequenceTickets < ActiveRecord::Migration[8.2]
  def change
    create_sequence_ticket_table(:app_sign_in_sequence_tickets, :user_tokens)
    create_sequence_ticket_table(:app_sign_up_sequence_tickets, :user_tokens)
  end
