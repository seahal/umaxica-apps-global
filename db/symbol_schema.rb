...
ActiveRecord::Schema[8.2].define(version: 2026_05_08_160000) do
  ...
  create_table "customer_reauth_sessions", force: :cascade do |t|
  ...
  create_table "customer_tokens", force: :cascade do |t|
    ...
    t.index ["purge_at"], name: "index_customer_tokens_on_purge_at"
    ...
    t.index ["session_id"], name: "index_customer_tokens_on_session_id"
