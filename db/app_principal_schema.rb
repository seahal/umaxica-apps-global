...
ActiveRecord::Schema[8.2].define(version: 2026_05_19_172001) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["terminated_at"], name: "index_users_on_terminated_at", where: "(terminated_at IS NOT NULL)"
  ...
  add_foreign_key "user_banners", "users"
  ...
  add_foreign_key "users", "user_multi_factor_statuses", column: "multi_factor_status_id"
  add_foreign_key "users", "user_multi_factors", column: "multi_factor_id"
