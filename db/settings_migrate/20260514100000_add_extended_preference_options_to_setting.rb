...
class AddExtendedPreferenceOptionsToSetting < ActiveRecord::Migration[8.2]
  TYPES = {
    currency: "currencies",
  ...
  def change
    add_local_columns(:visitor_preferences)

    create_preference_tables(:com, :com_preferences)
