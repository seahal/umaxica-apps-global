...
ActiveRecord::Schema[8.2].define(version: 2026_05_20_143007) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "citext"
  enable_extension "pg_catalog.plpgsql"
  enable_extension "pgcrypto"

  create_table "area_client_occurrences", force: :cascade do |t|
    ...
    t.index ["user_occurrence_id"], name: "index_area_client_occurrences_on_user_occurrence_id"
  end
  ...
  create_table "area_operator_occurrences", force: :cascade do |t|
    t.bigint "area_occurrence_id", null: false
    ...
    t.index ["staff_occurrence_id"], name: "index_area_operator_occurrences_on_staff_occurrence_id"
  end
  ...
  create_table "client_occurrence_statuses", force: :cascade do |t|
    t.string "name", default: "", null: false
  end

  create_table "client_occurrences", force: :cascade do |t|
    t.string "public_id", limit: 21, default: "", null: false
    t.string "body", default: "", null: false
    t.bigint "status_id", default: 0, null: false
    t.string "memo", default: "", null: false
    ...
    t.datetime "purged_at", precision: nil, default: ::Float::INFINITY, null: false
    t.datetime "discarded_at", default: ::Float::INFINITY, null: false
    t.index ["body"], name: "index_client_occurrences_on_body", unique: true
    t.index ["event_type", "created_at"], name: "index_client_occurrences_on_event_type_and_created_at"
    t.index ["public_id"], name: "index_client_occurrences_on_public_id", unique: true
    t.index ["purged_at"], name: "index_client_occurrences_on_purged_at"
    t.index ["status_id", "created_at"], name: "index_client_occurrences_on_status_id_and_created_at"
    t.check_constraint "discarded_at <= purged_at", name: "chk_user_occurrences_retention_order"
  end

  create_table "client_zip_occurrences", force: :cascade do |t|
    t.bigint "user_occurrence_id", null: false
    t.bigint "zip_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_occurrence_id", "zip_occurrence_id"], name: "idx_user_zip_occ_on_ids", unique: true
    t.index ["zip_occurrence_id"], name: "index_client_zip_occurrences_on_zip_occurrence_id"
  end

  create_table "domain_client_occurrences", force: :cascade do |t|
    t.bigint "domain_occurrence_id", null: false
    t.bigint "user_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["domain_occurrence_id", "user_occurrence_id"], name: "idx_domain_user_occ_on_ids", unique: true
    t.index ["user_occurrence_id"], name: "index_domain_client_occurrences_on_user_occurrence_id"
  end
  ...
  create_table "domain_operator_occurrences", force: :cascade do |t|
    t.bigint "domain_occurrence_id", null: false
    t.bigint "staff_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["domain_occurrence_id", "staff_occurrence_id"], name: "idx_domain_staff_occ_on_ids", unique: true
    t.index ["staff_occurrence_id"], name: "index_domain_operator_occurrences_on_staff_occurrence_id"
  end
  ...
  create_table "email_client_occurrences", force: :cascade do |t|
    t.bigint "email_occurrence_id", null: false
    t.bigint "user_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email_occurrence_id", "user_occurrence_id"], name: "idx_email_user_occ_on_ids", unique: true
    t.index ["user_occurrence_id"], name: "index_email_client_occurrences_on_user_occurrence_id"
  end
  ...
  create_table "email_operator_occurrences", force: :cascade do |t|
    t.bigint "email_occurrence_id", null: false
    t.bigint "staff_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email_occurrence_id", "staff_occurrence_id"], name: "idx_email_staff_occ_on_ids", unique: true
    t.index ["staff_occurrence_id"], name: "index_email_operator_occurrences_on_staff_occurrence_id"
  end
  ...
  create_table "ip_client_occurrences", force: :cascade do |t|
    t.bigint "ip_occurrence_id", null: false
    t.bigint "user_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ip_occurrence_id", "user_occurrence_id"], name: "idx_ip_user_occ_on_ids", unique: true
    t.index ["user_occurrence_id"], name: "index_ip_client_occurrences_on_user_occurrence_id"
  end
  ...
  create_table "ip_operator_occurrences", force: :cascade do |t|
    t.bigint "ip_occurrence_id", null: false
    t.bigint "staff_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ip_occurrence_id", "staff_occurrence_id"], name: "idx_ip_staff_occ_on_ids", unique: true
    t.index ["staff_occurrence_id"], name: "index_ip_operator_occurrences_on_staff_occurrence_id"
  end
  ...
  create_table "operator_client_occurrences", force: :cascade do |t|
    t.bigint "staff_occurrence_id", null: false
    t.bigint "user_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["staff_occurrence_id", "user_occurrence_id"], name: "idx_staff_user_occ_on_ids", unique: true
    t.index ["user_occurrence_id"], name: "index_operator_client_occurrences_on_user_occurrence_id"
  end

  create_table "operator_occurrence_statuses", force: :cascade do |t|
    t.string "name", default: "", null: false
  end

  create_table "operator_occurrences", force: :cascade do |t|
    t.string "public_id", limit: 21, default: "", null: false
    t.string "body", default: "", null: false
    t.bigint "status_id", default: 0, null: false
    t.string "memo", default: "", null: false
    ...
    t.datetime "purged_at", precision: nil, default: ::Float::INFINITY, null: false
    t.datetime "discarded_at", default: ::Float::INFINITY, null: false
    t.index ["body"], name: "index_operator_occurrences_on_body", unique: true
    t.index ["event_type", "created_at"], name: "index_operator_occurrences_on_event_type_and_created_at"
    t.index ["public_id"], name: "index_operator_occurrences_on_public_id", unique: true
    t.index ["purged_at"], name: "index_operator_occurrences_on_purged_at"
    t.index ["status_id", "created_at"], name: "index_operator_occurrences_on_status_id_and_created_at"
    t.check_constraint "discarded_at <= purged_at", name: "chk_staff_occurrences_retention_order"
  end

  create_table "operator_telephone_occurrences", force: :cascade do |t|
    t.bigint "staff_occurrence_id", null: false
    t.bigint "telephone_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["staff_occurrence_id", "telephone_occurrence_id"], name: "idx_staff_telephone_occ_on_ids", unique: true
    t.index ["telephone_occurrence_id"], name: "idx_on_telephone_occurrence_id_de4dc4cae4"
  end

  create_table "operator_zip_occurrences", force: :cascade do |t|
    t.bigint "staff_occurrence_id", null: false
    t.bigint "zip_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["staff_occurrence_id", "zip_occurrence_id"], name: "idx_staff_zip_occ_on_ids", unique: true
    t.index ["zip_occurrence_id"], name: "index_operator_zip_occurrences_on_zip_occurrence_id"
  end

  create_table "telephone_client_occurrences", force: :cascade do |t|
    t.bigint "telephone_occurrence_id", null: false
    t.bigint "user_occurrence_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["telephone_occurrence_id", "user_occurrence_id"], name: "idx_telephone_user_occ_on_ids", unique: true
    t.index ["user_occurrence_id"], name: "index_telephone_client_occurrences_on_user_occurrence_id"
  end
  ...
  add_foreign_key "area_client_occurrences", "area_occurrences", validate: false
  add_foreign_key "area_client_occurrences", "client_occurrences", column: "user_occurrence_id", validate: false
  ...
  add_foreign_key "area_operator_occurrences", "area_occurrences", validate: false
  add_foreign_key "area_operator_occurrences", "operator_occurrences", column: "staff_occurrence_id", validate: false
  ...
  add_foreign_key "client_occurrences", "client_occurrence_statuses", column: "status_id", name: "fk_user_occurrences_on_status_id"
  add_foreign_key "client_zip_occurrences", "client_occurrences", column: "user_occurrence_id", validate: false
  add_foreign_key "client_zip_occurrences", "zip_occurrences", validate: false
  add_foreign_key "domain_client_occurrences", "client_occurrences", column: "user_occurrence_id", validate: false
  add_foreign_key "domain_client_occurrences", "domain_occurrences", validate: false
  ...
  add_foreign_key "domain_operator_occurrences", "domain_occurrences", validate: false
  add_foreign_key "domain_operator_occurrences", "operator_occurrences", column: "staff_occurrence_id", validate: false
  ...
  add_foreign_key "email_client_occurrences", "client_occurrences", column: "user_occurrence_id", validate: false
  add_foreign_key "email_client_occurrences", "email_occurrences", validate: false
  ...
  add_foreign_key "email_operator_occurrences", "email_occurrences", validate: false
  add_foreign_key "email_operator_occurrences", "operator_occurrences", column: "staff_occurrence_id", validate: false
  ...
  add_foreign_key "ip_client_occurrences", "client_occurrences", column: "user_occurrence_id", validate: false
  add_foreign_key "ip_client_occurrences", "ip_occurrences", validate: false
  add_foreign_key "ip_occurrences", "ip_occurrence_statuses", column: "status_id", name: "fk_ip_occurrences_on_status_id"
  add_foreign_key "ip_operator_occurrences", "ip_occurrences", validate: false
  add_foreign_key "ip_operator_occurrences", "operator_occurrences", column: "staff_occurrence_id", validate: false
  ...
  add_foreign_key "operator_client_occurrences", "client_occurrences", column: "user_occurrence_id", validate: false
  add_foreign_key "operator_client_occurrences", "operator_occurrences", column: "staff_occurrence_id", validate: false
  add_foreign_key "operator_occurrences", "operator_occurrence_statuses", column: "status_id", name: "fk_staff_occurrences_on_status_id"
  add_foreign_key "operator_telephone_occurrences", "operator_occurrences", column: "staff_occurrence_id", validate: false
  add_foreign_key "operator_telephone_occurrences", "telephone_occurrences", validate: false
  add_foreign_key "operator_zip_occurrences", "operator_occurrences", column: "staff_occurrence_id", validate: false
  add_foreign_key "operator_zip_occurrences", "zip_occurrences", validate: false
  add_foreign_key "telephone_client_occurrences", "client_occurrences", column: "user_occurrence_id", validate: false
  add_foreign_key "telephone_client_occurrences", "telephone_occurrences", validate: false
