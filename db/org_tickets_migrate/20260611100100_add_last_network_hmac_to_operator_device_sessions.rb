...
# Adds a coarse, privacy-preserving network fingerprint to operator device
...
class AddLastNetworkHmacToOperatorDeviceSessions < ActiveRecord::Migration[8.2]
  disable_ddl_transaction!

  def change
    add_column :operator_device_sessions, :last_network_hmac, :string
  end
end
