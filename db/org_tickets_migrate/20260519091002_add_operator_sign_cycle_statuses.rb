class AddOperatorSignCycleStatuses < ActiveRecord::Migration[8.2]
  disable_ddl_transaction!

  def change
    create_status_table(:operator_sign_in_cycle_statuses)
    create_status_table(:operator_sign_up_cycle_statuses)

    add_cycle_status(:org_sign_in_cycles, :operator_sign_in_cycle_statuses)
    add_cycle_status(:org_sign_up_cycles, :operator_sign_up_cycle_statuses)
  end
