...
ActiveRecord::Schema[8.2].define(version: 2026_05_20_193000) do
  ...
  add_foreign_key "operators", "staff_multi_factor_statuses", column: "multi_factor_status_id"
  add_foreign_key "operators", "staff_multi_factors", column: "multi_factor_id"
  ...
  add_foreign_key "staff_banners", "operators", column: "staff_id"
  add_foreign_key "staff_bulletins", "operators", column: "staff_id"
  add_foreign_key "staff_emails", "operators", column: "staff_id"
  ...
  add_foreign_key "staff_passkeys", "operators", column: "staff_id"
  ...
  add_foreign_key "staff_secrets", "operators", column: "staff_id"
  ...
  add_foreign_key "staff_telephones", "operators", column: "staff_id"
