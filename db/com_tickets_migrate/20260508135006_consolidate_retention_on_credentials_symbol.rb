class ConsolidateRetentionOnCredentialsSymbol < ActiveRecord::Migration[8.0]
  def change
    safety_assured do
    tables = %w[customer_verifications customer_authorization_codes customer_reauth_sessions customer_secrets]
    tables.each do |t|
      if table_exists?(t)
