...
class RepairUserEmailStatusReferenceData < ActiveRecord::Migration[8.2]
  USER_EMAIL_STATUSES = {
    1 => "UNVERIFIED",
    2 => "VERIFIED",
    3 => "SUSPENDED",
  ...
  def down
    # No-op: these fixed reference rows are shared data and may be referenced by user_emails.
  end
