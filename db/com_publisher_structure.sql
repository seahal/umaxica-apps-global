...
CREATE TABLE public.com_post_categories (
    id bigint NOT NULL,
...
CREATE SEQUENCE public.com_post_categories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: com_post_categorizations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.com_post_categorizations (
    id bigint NOT NULL,
...
--
-- Name: com_post_categorizations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.com_post_categorizations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: com_post_categorizations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.com_post_categorizations_id_seq OWNED BY public.com_post_categorizations.id;
...
CREATE TABLE public.com_post_review_statuses (
    id bigint NOT NULL
);
...
CREATE SEQUENCE public.com_post_review_statuses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.com_post_reviews (
    id bigint NOT NULL,
    comment text,
...
CREATE SEQUENCE public.com_post_reviews_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.com_post_revisions (
    id bigint NOT NULL,
    body text,
...
CREATE SEQUENCE public.com_post_revisions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.com_post_statuses (
    id bigint NOT NULL
);
...
CREATE SEQUENCE public.com_post_statuses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: com_post_taggings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.com_post_taggings (
    id bigint NOT NULL,
    com_post_id bigint NOT NULL,
...
--
-- Name: com_post_taggings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.com_post_taggings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: com_post_taggings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.com_post_taggings_id_seq OWNED BY public.com_post_taggings.id;
...
CREATE TABLE public.com_post_tags (
    id bigint NOT NULL,
    parent_id bigint DEFAULT 0 NOT NULL
);
...
CREATE SEQUENCE public.com_post_tags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.com_post_versions (
    id bigint NOT NULL,
    body text,
    description character varying,
    edited_by_id bigint,
...
CREATE SEQUENCE public.com_post_versions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: com_post_categorizations id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.com_post_categorizations ALTER COLUMN id SET DEFAULT nextval('public.com_post_categorizations_id_seq'::regclass);
...
--
-- Name: com_post_taggings id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.com_post_taggings ALTER COLUMN id SET DEFAULT nextval('public.com_post_taggings_id_seq'::regclass);
...
--
-- Name: com_post_categorizations com_post_categories_master_id_non_negative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE public.com_post_categorizations
    ADD CONSTRAINT com_post_categories_master_id_non_negative CHECK ((com_post_category_id >= 0)) NOT VALID;
...
--
-- Name: com_post_categorizations com_post_categorizations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.com_post_categorizations
    ADD CONSTRAINT com_post_categorizations_pkey PRIMARY KEY (id);


--
-- Name: com_post_categories com_post_category_masters_parent_id_non_negative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: com_post_tags com_post_tag_masters_parent_id_non_negative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: com_post_taggings com_post_taggings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.com_post_taggings
    ADD CONSTRAINT com_post_taggings_pkey PRIMARY KEY (id);


--
-- Name: com_post_taggings com_post_tags_master_id_non_negative; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE public.com_post_taggings
    ADD CONSTRAINT com_post_tags_master_id_non_negative CHECK ((com_post_tag_id >= 0)) NOT VALID;
...
--
-- Name: index_com_post_categories_on_parent_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_com_post_categories_on_parent_id ON public.com_post_categories USING btree (parent_id);


--
-- Name: index_com_post_categorizations_on_com_post_category_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_com_post_categorizations_on_com_post_category_id ON public.com_post_categorizations USING btree (com_post_category_id);


--
-- Name: index_com_post_categorizations_on_com_post_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_com_post_categorizations_on_com_post_id ON public.com_post_categorizations USING btree (com_post_id);
...
--
-- Name: index_com_post_taggings_on_com_post_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_com_post_taggings_on_com_post_id ON public.com_post_taggings USING btree (com_post_id);


--
-- Name: index_com_post_taggings_on_com_post_tag_id_and_com_post_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_com_post_taggings_on_com_post_tag_id_and_com_post_id ON public.com_post_taggings USING btree (com_post_tag_id, com_post_id);


--
-- Name: index_com_post_tags_on_parent_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_com_post_tags_on_parent_id ON public.com_post_tags USING btree (parent_id);
...
--
-- Name: com_post_categorizations fk_rails_1c8744edf5; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: com_post_categorizations fk_rails_a677300bb6; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.com_post_categorizations
    ADD CONSTRAINT fk_rails_a677300bb6 FOREIGN KEY (com_post_category_id) REFERENCES public.com_post_categories(id);
...
--
-- Name: com_post_taggings fk_rails_e33f9a0083; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.com_post_taggings
    ADD CONSTRAINT fk_rails_e33f9a0083 FOREIGN KEY (com_post_tag_id) REFERENCES public.com_post_tags(id);


--
-- Name: com_post_taggings fk_rails_fdf74b486b; Type: FK CONSTRAINT; Schema: public; Owner: -
--
