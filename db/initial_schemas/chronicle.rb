...
ActiveRecord::Schema[8.2].define(version: 20_260_329_155_000) do
  ...
  create_table "app_contact_histories", force: :cascade do |t|
    ...
    t.index(%w(subject_type subject_id occurred_at), name: "idx_on_subject_type_subject_id_occurred_at_21d52ab3f6")
  ...
  create_table "com_contact_audits", force: :cascade do |t|
    ...
    t.index(%w(subject_type subject_id occurred_at), name: "idx_on_subject_type_subject_id_occurred_at_1ec6aec32c")
  ...
  create_table "org_contact_histories", force: :cascade do |t|
    ...
    t.index(%w(subject_type subject_id occurred_at), name: "idx_on_subject_type_subject_id_occurred_at_3eb778d373")
