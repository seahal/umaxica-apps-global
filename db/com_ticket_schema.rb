...
ActiveRecord::Schema[8.2].define(version: 2026_05_20_190002) do
  ...
  create_table "com_sign_in_cycles", force: :cascade do |t|
    ...
    t.index ["discarded_at"], name: "index_com_sign_in_cycles_on_discarded_at"
    t.index ["expires_at"], name: "index_com_sign_in_cycles_on_expires_at"
    t.index ["principal_id"], name: "index_com_sign_in_cycles_on_principal_id"
    t.index ["public_id"], name: "index_com_sign_in_cycles_on_public_id", unique: true
    t.index ["state"], name: "index_com_sign_in_cycles_on_state"
    t.index ["status_id"], name: "index_com_sign_in_cycles_on_status_id"
    t.index ["token_id"], name: "index_com_sign_in_cycles_on_token_id"
  ...
  create_table "com_sign_up_cycles", force: :cascade do |t|
    t.string "public_id", limit: 21, null: false
    t.bigint "principal_id"
    t.bigint "token_id"
    t.string "state", null: false
    ...
    t.index ["cleanup_token"], name: "index_com_sign_up_cycles_on_cleanup_token"
    t.index ["discarded_at"], name: "index_com_sign_up_cycles_on_discarded_at"
    t.index ["expires_at"], name: "index_com_sign_up_cycles_on_expires_at"
    t.index ["pending_contact_id"], name: "index_com_sign_up_cycles_on_pending_contact_id"
    t.index ["principal_id"], name: "index_com_sign_up_cycles_on_principal_id"
    t.index ["public_id"], name: "index_com_sign_up_cycles_on_public_id", unique: true
    t.index ["state"], name: "index_com_sign_up_cycles_on_state"
    t.index ["status_id", "expires_at"], name: "index_com_sign_up_cycles_on_status_id_and_expires_at"
    t.index ["status_id"], name: "index_com_sign_up_cycles_on_status_id"
    t.index ["token_id"], name: "index_com_sign_up_cycles_on_token_id"
  ...
  create_table "device_sessions", force: :cascade do |t|
    ...
    t.index ["visitor_id"], name: "index_device_sessions_on_visitor_id"
  end
  ...
  add_foreign_key "com_sign_in_cycles", "visitor_sign_in_cycle_statuses", column: "status_id", validate: false
  add_foreign_key "com_sign_in_cycles", "visitor_tokens", column: "token_id", on_delete: :cascade, validate: false
  add_foreign_key "com_sign_up_cycles", "visitor_sign_up_cycle_statuses", column: "status_id", validate: false
  add_foreign_key "com_sign_up_cycles", "visitor_tokens", column: "token_id", on_delete: :cascade, validate: false
