...
ActiveRecord::Schema[8.2].define(version: 2026_05_25_233000) do
  ...
  create_table "visitor_sign_in_cycles", force: :cascade do |t|
    ...
    t.index ["selected_persona_id"], name: "index_visitor_sign_in_cycles_on_selected_persona_id"
    t.index ["selected_region_id"], name: "index_visitor_sign_in_cycles_on_selected_region_id"
