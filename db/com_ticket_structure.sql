...
--
-- Name: visitor_token_usages; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.visitor_token_usages (
    id bigint NOT NULL,
    visitor_token_id bigint NOT NULL,
    public_id character varying(21) NOT NULL,
...
--
-- Name: visitor_token_usages_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.visitor_token_usages_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: visitor_token_usages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.visitor_token_usages_id_seq OWNED BY public.visitor_token_usages.id;
...
--
-- Name: visitor_token_usages id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.visitor_token_usages ALTER COLUMN id SET DEFAULT nextval('public.visitor_token_usages_id_seq'::regclass);
...
--
-- Name: visitor_token_usages visitor_token_usages_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.visitor_token_usages
    ADD CONSTRAINT visitor_token_usages_pkey PRIMARY KEY (id);
...
--
-- Name: idx_active_visitor_token_usage_per_rp; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_active_visitor_token_usage_per_rp ON public.visitor_token_usages USING btree (visitor_token_id, oidc_client_id) WHERE (revoked_at IS NULL);
...
--
-- Name: index_visitor_authorization_codes_on_visitor_token_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_visitor_authorization_codes_on_visitor_token_id ON public.visitor_authorization_codes USING btree (visitor_token_id);
...
--
-- Name: index_visitor_token_usages_on_oidc_client_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_visitor_token_usages_on_oidc_client_id ON public.visitor_token_usages USING btree (oidc_client_id);


--
-- Name: index_visitor_token_usages_on_public_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_visitor_token_usages_on_public_id ON public.visitor_token_usages USING btree (public_id);


--
-- Name: index_visitor_token_usages_on_refresh_token_digest; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_visitor_token_usages_on_refresh_token_digest ON public.visitor_token_usages USING btree (refresh_token_digest) WHERE (refresh_token_digest IS NOT NULL);


--
-- Name: index_visitor_token_usages_on_revoked_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_visitor_token_usages_on_revoked_at ON public.visitor_token_usages USING btree (revoked_at);


--
-- Name: index_visitor_token_usages_on_visitor_token_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_visitor_token_usages_on_visitor_token_id ON public.visitor_token_usages USING btree (visitor_token_id);
...
--
-- Name: visitor_token_usages fk_rails_110f05fbb6; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.visitor_token_usages
    ADD CONSTRAINT fk_rails_110f05fbb6 FOREIGN KEY (visitor_token_id) REFERENCES public.visitor_tokens(id) ON DELETE CASCADE;
...
--
-- Name: visitor_authorization_codes fk_rails_41db1e0f97; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: visitor_sign_up_flows fk_rails_85a641d47f; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: visitor_sign_up_flows fk_rails_8cef237db7; Type: FK CONSTRAINT; Schema: public; Owner: -
--
