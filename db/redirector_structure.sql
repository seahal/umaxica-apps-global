...
CREATE TABLE public.app_jump_links (
    id bigint NOT NULL,
...
CREATE SEQUENCE public.app_jump_links_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.com_jump_links (
    id bigint NOT NULL,
    public_id character varying NOT NULL,
    destination_url text NOT NULL,
    status_id integer DEFAULT 0 NOT NULL,
...
CREATE SEQUENCE public.com_jump_links_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.org_jump_links (
    id bigint NOT NULL,
    public_id character varying NOT NULL,
    destination_url text NOT NULL,
    status_id integer DEFAULT 0 NOT NULL,
...
CREATE SEQUENCE public.org_jump_links_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
