...
ALTER TABLE ONLY public.client_authorization_codes
    ADD CONSTRAINT fk_rails_1da368d755 FOREIGN KEY (client_token_id) REFERENCES public.client_tokens(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.client_sign_up_flows
    ADD CONSTRAINT fk_rails_7b193122e7 FOREIGN KEY (token_id) REFERENCES public.client_tokens(id) ON DELETE CASCADE;
