...
ActiveRecord::Schema[8.2].define(version: 2026_05_08_160000) do
  ...
  create_table "staff_authorization_codes", force: :cascade do |t|
    ...
    t.check_constraint "lapses_at <= purge_at", name: "chk_staff_authorization_codes_retention_order"
  end

  create_table "staff_reauth_sessions", force: :cascade do |t|
  ...
  create_table "staff_tokens", force: :cascade do |t|
    ...
    t.index ["purge_at"], name: "index_staff_tokens_on_purge_at"
    ...
    t.index ["session_id"], name: "index_staff_tokens_on_session_id"
  ...
  create_table "staff_verifications", force: :cascade do |t|
    ...
    t.check_constraint "lapses_at <= purge_at", name: "chk_staff_verifications_retention_order"
  end
