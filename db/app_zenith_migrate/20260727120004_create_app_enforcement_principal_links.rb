...
class CreateAppEnforcementPrincipalLinks < ActiveRecord::Migration[8.2]
  def up
    create_table(:app_enforcement_principal_links) do |t|
      ...
      t.check_constraint(
        ...
        name: "chk_app_enforcement_principal_links_relationship_kind",
      )
    end
  end

  def down
    drop_table(:app_enforcement_principal_links)
  end
end
